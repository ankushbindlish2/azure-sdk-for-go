...
// VulnerabilityAssessmentScanRecordForSQLListResult - The response of a SqlVulnerabilityAssessmentScanRecord list operation.
type VulnerabilityAssessmentScanRecordForSQLListResult struct {
	// REQUIRED; The SqlVulnerabilityAssessmentScanRecord items on this page
...
// VulnerabilityAssessmentScanRecordListResult - The response of a VulnerabilityAssessmentScanRecord list operation.
type VulnerabilityAssessmentScanRecordListResult struct {
	// REQUIRED; The VulnerabilityAssessmentScanRecord items on this page
