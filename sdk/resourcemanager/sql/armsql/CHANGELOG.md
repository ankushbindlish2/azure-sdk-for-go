...
- Type of `DatabaseAdvancedThreatProtection.SystemData` has been changed from `*SystemData` to `*Systemdata`
- Type of `DatabaseSQLVulnerabilityAssessmentBaselineSet.SystemData` has been changed from `*SystemData` to `*Systemdata`
- Type of `DatabaseSQLVulnerabilityAssessmentRuleBaseline.SystemData` has been changed from `*SystemData` to `*Systemdata`
- Type of `DatabaseSQLVulnerabilityAssessmentRuleBaselineInput.SystemData` has been changed from `*SystemData` to `*Systemdata`
- Type of `DatabaseSQLVulnerabilityAssessmentRuleBaselineListInput.SystemData` has been changed from `*SystemData` to `*Systemdata`
- Type of `DatabaseSecurityAlertPolicy.SystemData` has been changed from `*SystemData` to `*Systemdata`
...
- Type of `ManagedDatabaseAdvancedThreatProtection.SystemData` has been changed from `*SystemData` to `*Systemdata`
...
- Type of `ManagedInstanceAdvancedThreatProtection.SystemData` has been changed from `*SystemData` to `*Systemdata`
...
- Type of `ManagedServerSecurityAlertPolicy.SystemData` has been changed from `*SystemData` to `*Systemdata`
- Type of `RecommendedActionProperties.Details` has been changed from `map[string]any` to `map[string]*string`
- Type of `ServerAdvancedThreatProtection.SystemData` has been changed from `*SystemData` to `*Systemdata`
- Type of `ServerDevOpsAuditingSettings.SystemData` has been changed from `*SystemData` to `*Systemdata`
- Type of `ServerSecurityAlertPolicy.SystemData` has been changed from `*SystemData` to `*Systemdata`
- Type of `StartStopManagedInstanceSchedule.SystemData` has been changed from `*SystemData` to `*Systemdata`
- Type of `TopQueries.Queries` has been changed from `[]*QueryStatisticsPropertiesAutoGenerated` to `[]*QueryStatisticsProperties`
- Type of `VulnerabilityAssessment.SystemData` has been changed from `*SystemData` to `*Systemdata`
- Type of `VulnerabilityAssessmentScanRecordForSQL.SystemData` has been changed from `*SystemData` to `*Systemdata`
- Type of `VulnerabilityAssessmentScanResults.SystemData` has been changed from `*SystemData` to `*Systemdata`
