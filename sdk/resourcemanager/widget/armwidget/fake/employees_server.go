...
// EmployeesServer is a fake server for instances of the armwidget.EmployeesClient type.
type EmployeesServer struct {
	// BeginCreateOrUpdate is the fake for method EmployeesClient.BeginCreateOrUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, employeeName string, resource armwidget.Employee, options *armwidget.EmployeesClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armwidget.EmployeesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method EmployeesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, employeeName string, options *armwidget.EmployeesClientBeginDeleteOptions) (resp azfake.PollerResponder[armwidget.EmployeesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method EmployeesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, employeeName string, options *armwidget.EmployeesClientGetOptions) (resp azfake.Responder[armwidget.EmployeesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByResourceGroupPager is the fake for method EmployeesClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armwidget.EmployeesClientListByResourceGroupOptions) (resp azfake.PagerResponder[armwidget.EmployeesClientListByResourceGroupResponse])

	// NewListBySubscriptionPager is the fake for method EmployeesClient.NewListBySubscriptionPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListBySubscriptionPager func(options *armwidget.EmployeesClientListBySubscriptionOptions) (resp azfake.PagerResponder[armwidget.EmployeesClientListBySubscriptionResponse])

	// Update is the fake for method EmployeesClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, employeeName string, properties armwidget.Employee, options *armwidget.EmployeesClientUpdateOptions) (resp azfake.Responder[armwidget.EmployeesClientUpdateResponse], errResp azfake.ErrorResponder)
}

// NewEmployeesServerTransport creates a new instance of EmployeesServerTransport with the provided implementation.
// The returned EmployeesServerTransport instance is connected to an instance of armwidget.EmployeesClient via the
...
func NewEmployeesServerTransport(srv *EmployeesServer) *EmployeesServerTransport {
	return &EmployeesServerTransport{
		srv:                         srv,
		beginCreateOrUpdate:         newTracker[azfake.PollerResponder[armwidget.EmployeesClientCreateOrUpdateResponse]](),
		beginDelete:                 newTracker[azfake.PollerResponder[armwidget.EmployeesClientDeleteResponse]](),
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armwidget.EmployeesClientListByResourceGroupResponse]](),
		newListBySubscriptionPager:  newTracker[azfake.PagerResponder[armwidget.EmployeesClientListBySubscriptionResponse]](),
	}
}

// EmployeesServerTransport connects instances of armwidget.EmployeesClient to instances of EmployeesServer.
// Don't use this type directly, use NewEmployeesServerTransport instead.
type EmployeesServerTransport struct {
	srv                         *EmployeesServer
	beginCreateOrUpdate         *tracker[azfake.PollerResponder[armwidget.EmployeesClientCreateOrUpdateResponse]]
	beginDelete                 *tracker[azfake.PollerResponder[armwidget.EmployeesClientDeleteResponse]]
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armwidget.EmployeesClientListByResourceGroupResponse]]
	newListBySubscriptionPager  *tracker[azfake.PagerResponder[armwidget.EmployeesClientListBySubscriptionResponse]]
}
...
func (e *EmployeesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Widget/employees/(?P<employeeName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 4 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		}
		body, err := server.UnmarshalRequestAsJSON[armwidget.Employee](req)
		if err != nil {
			return nil, err
		}
...
func (e *EmployeesServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Widget/employees`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 3 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armwidget.EmployeesClientListByResourceGroupResponse, createLink func() string) {
...
func (e *EmployeesServerTransport) dispatchNewListBySubscriptionPager(req *http.Request) (*http.Response, error) {
	...
	if newListBySubscriptionPager == nil {
		const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Widget/employees`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 2 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		server.PagerResponderInjectNextLinks(newListBySubscriptionPager, req, func(page *armwidget.EmployeesClientListBySubscriptionResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
