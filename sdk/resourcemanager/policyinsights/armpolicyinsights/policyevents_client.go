...
//     method.
func (client *PolicyEventsClient) NewListQueryResultsForPolicyDefinitionPager(subscriptionID string, policyEventsResource PolicyEventsResourceType, policyDefinitionName string, options *PolicyEventsClientListQueryResultsForPolicyDefinitionOptions) *runtime.Pager[PolicyEventsClientListQueryResultsForPolicyDefinitionResponse] {
	return runtime.NewPager(runtime.PagingHandler[PolicyEventsClientListQueryResultsForPolicyDefinitionResponse]{
		...
		Fetcher: func(ctx context.Context, page *PolicyEventsClientListQueryResultsForPolicyDefinitionResponse) (PolicyEventsClientListQueryResultsForPolicyDefinitionResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listQueryResultsForPolicyDefinitionCreateRequest(ctx, subscriptionID, policyEventsResource, policyDefinitionName, options)
			}, nil)
			if err != nil {
...
func (client *PolicyEventsClient) listQueryResultsForPolicyDefinitionCreateRequest(ctx context.Context, subscriptionID string, policyEventsResource PolicyEventsResourceType, policyDefinitionName string, options *PolicyEventsClientListQueryResultsForPolicyDefinitionOptions) (*policy.Request, error) {
...
//     method.
func (client *PolicyEventsClient) NewListQueryResultsForPolicySetDefinitionPager(subscriptionID string, policyEventsResource PolicyEventsResourceType, policySetDefinitionName string, options *PolicyEventsClientListQueryResultsForPolicySetDefinitionOptions) *runtime.Pager[PolicyEventsClientListQueryResultsForPolicySetDefinitionResponse] {
	return runtime.NewPager(runtime.PagingHandler[PolicyEventsClientListQueryResultsForPolicySetDefinitionResponse]{
		...
		Fetcher: func(ctx context.Context, page *PolicyEventsClientListQueryResultsForPolicySetDefinitionResponse) (PolicyEventsClientListQueryResultsForPolicySetDefinitionResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listQueryResultsForPolicySetDefinitionCreateRequest(ctx, subscriptionID, policyEventsResource, policySetDefinitionName, options)
			}, nil)
			if err != nil {
...
func (client *PolicyEventsClient) listQueryResultsForPolicySetDefinitionCreateRequest(ctx context.Context, subscriptionID string, policyEventsResource PolicyEventsResourceType, policySetDefinitionName string, options *PolicyEventsClientListQueryResultsForPolicySetDefinitionOptions) (*policy.Request, error) {
...
func (client *PolicyEventsClient) NewListQueryResultsForResourceGroupLevelPolicyAssignmentPager(subscriptionID string, resourceGroupName string, policyEventsResource PolicyEventsResourceType, policyAssignmentName string, options *PolicyEventsClientListQueryResultsForResourceGroupLevelPolicyAssignmentOptions) *runtime.Pager[PolicyEventsClientListQueryResultsForResourceGroupLevelPolicyAssignmentResponse] {
	return runtime.NewPager(runtime.PagingHandler[PolicyEventsClientListQueryResultsForResourceGroupLevelPolicyAssignmentResponse]{
		...
		Fetcher: func(ctx context.Context, page *PolicyEventsClientListQueryResultsForResourceGroupLevelPolicyAssignmentResponse) (PolicyEventsClientListQueryResultsForResourceGroupLevelPolicyAssignmentResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listQueryResultsForResourceGroupLevelPolicyAssignmentCreateRequest(ctx, subscriptionID, resourceGroupName, policyEventsResource, policyAssignmentName, options)
			}, nil)
			if err != nil {
...
func (client *PolicyEventsClient) listQueryResultsForResourceGroupLevelPolicyAssignmentCreateRequest(ctx context.Context, subscriptionID string, resourceGroupName string, policyEventsResource PolicyEventsResourceType, policyAssignmentName string, options *PolicyEventsClientListQueryResultsForResourceGroupLevelPolicyAssignmentOptions) (*policy.Request, error) {
...
func (client *PolicyEventsClient) NewListQueryResultsForSubscriptionLevelPolicyAssignmentPager(subscriptionID string, policyEventsResource PolicyEventsResourceType, policyAssignmentName string, options *PolicyEventsClientListQueryResultsForSubscriptionLevelPolicyAssignmentOptions) *runtime.Pager[PolicyEventsClientListQueryResultsForSubscriptionLevelPolicyAssignmentResponse] {
	return runtime.NewPager(runtime.PagingHandler[PolicyEventsClientListQueryResultsForSubscriptionLevelPolicyAssignmentResponse]{
		...
		Fetcher: func(ctx context.Context, page *PolicyEventsClientListQueryResultsForSubscriptionLevelPolicyAssignmentResponse) (PolicyEventsClientListQueryResultsForSubscriptionLevelPolicyAssignmentResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listQueryResultsForSubscriptionLevelPolicyAssignmentCreateRequest(ctx, subscriptionID, policyEventsResource, policyAssignmentName, options)
			}, nil)
			if err != nil {
...
func (client *PolicyEventsClient) listQueryResultsForSubscriptionLevelPolicyAssignmentCreateRequest(ctx context.Context, subscriptionID string, policyEventsResource PolicyEventsResourceType, policyAssignmentName string, options *PolicyEventsClientListQueryResultsForSubscriptionLevelPolicyAssignmentOptions) (*policy.Request, error) {
