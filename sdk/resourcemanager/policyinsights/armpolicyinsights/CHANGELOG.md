...
- Function `NewClientFactory` parameter(s) have been changed from `(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions)` to `(credential azcore.TokenCredential, options *arm.ClientOptions)`
- Function `*ClientFactory.NewAttestationsClient` parameter(s) have been changed from `(<none>)` to `(subscriptionID string)`
- Function `*ClientFactory.NewComponentPolicyStatesClient` parameter(s) have been changed from `(<none>)` to `(subscriptionID string)`
- Function `*ClientFactory.NewPolicyEventsClient` parameter(s) have been changed from `(<none>)` to `(subscriptionID string)`
- Function `*ClientFactory.NewPolicyRestrictionsClient` parameter(s) have been changed from `(<none>)` to `(subscriptionID string)`
- Function `*ClientFactory.NewPolicyStatesClient` parameter(s) have been changed from `(<none>)` to `(subscriptionID string)`
- Function `*ClientFactory.NewPolicyTrackedResourcesClient` parameter(s) have been changed from `(<none>)` to `(subscriptionID string)`
- Function `*ClientFactory.NewRemediationsClient` parameter(s) have been changed from `(<none>)` to `(subscriptionID string)`
