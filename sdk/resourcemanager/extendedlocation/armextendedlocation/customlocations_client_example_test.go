...
// Generated from example definition: 2021-08-31-preview/CustomLocationsCreate_Update.json
func ExampleCustomLocationsClient_BeginCreateOrUpdate() {
	...
	// res = armextendedlocation.CustomLocationsClientCreateOrUpdateResponse{
...
// Generated from example definition: 2021-08-31-preview/CustomLocationsDelete.json
...
// Generated from example definition: 2021-08-31-preview/CustomLocationsFindTargetResourceGroup.json
func ExampleCustomLocationsClient_FindTargetResourceGroup() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armextendedlocation.CustomLocationsClientFindTargetResourceGroupResponse{
	// 	CustomLocationFindTargetResourceGroupResult: &armextendedlocation.CustomLocationFindTargetResourceGroupResult{
...
// Generated from example definition: 2021-08-31-preview/CustomLocationsGet.json
func ExampleCustomLocationsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armextendedlocation.CustomLocationsClientGetResponse{
	// 	CustomLocation: &armextendedlocation.CustomLocation{
	// 		Name: to.Ptr("customLocation01"),
	// 		Type: to.Ptr("Microsoft.ExtendedLocation/customLocations"),
	// 		ID: to.Ptr("/subscriptions/11111111-2222-3333-4444-555555555555/resourceGroups/testrg/providers/Microsoft.ExtendedLocation/customLocations/customLocation01"),
...
// Generated from example definition: 2021-08-31-preview/CustomLocationsListByResourceGroup.json
func ExampleCustomLocationsClient_NewListByResourceGroupPager() {
	...
	for pager.More() {
		...
		// page = armextendedlocation.CustomLocationsClientListByResourceGroupResponse{
		// 	CustomLocationListResult: armextendedlocation.CustomLocationListResult{
...
// Generated from example definition: 2021-08-31-preview/CustomLocationsListBySubscription.json
func ExampleCustomLocationsClient_NewListBySubscriptionPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armextendedlocation.CustomLocationsClientListBySubscriptionResponse{
		// 	CustomLocationListResult: armextendedlocation.CustomLocationListResult{
		// 		Value: []*armextendedlocation.CustomLocation{
		// 			{
		// 				Name: to.Ptr("customLocation01"),
...
// Generated from example definition: 2021-08-31-preview/CustomLocationsListEnabledResourceTypes.json
func ExampleCustomLocationsClient_NewListEnabledResourceTypesPager() {
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armextendedlocation.CustomLocationsClientListEnabledResourceTypesResponse{
		// 	EnabledResourceTypesListResult: armextendedlocation.EnabledResourceTypesListResult{
...
// Generated from example definition: 2021-08-31-preview/CustomLocationsListOperations.json
func ExampleCustomLocationsClient_NewListOperationsPager() {
	...
	ctx := context.Background()
	clientFactory, err := armextendedlocation.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
		log.Fatalf("failed to create client: %v", err)
	}
	...
	for pager.More() {
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armextendedlocation.CustomLocationsClientListOperationsResponse{
		// 	CustomLocationOperationsList: armextendedlocation.CustomLocationOperationsList{
...
// Generated from example definition: 2021-08-31-preview/CustomLocationsPatch.json
func ExampleCustomLocationsClient_Update() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armextendedlocation.CustomLocationsClientUpdateResponse{
	// 	CustomLocation: &armextendedlocation.CustomLocation{
	// 		Name: to.Ptr("customLocation01"),
	// 		Type: to.Ptr("Microsoft.ExtendedLocation/customLocations"),
	// 		ID: to.Ptr("/subscriptions/11111111-2222-3333-4444-555555555555/resourceGroups/testrg/providers/Microsoft.ExtendedLocation/customLocations/customLocation01"),
