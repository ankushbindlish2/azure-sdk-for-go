...
func (client *CommunityGalleriesClient) Get(ctx context.Context, apiVersion string, location string, publicGalleryName string, options *CommunityGalleriesClientGetOptions) (CommunityGalleriesClientGetResponse, error) {
	var err error
	const operationName = "CommunityGalleriesClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, apiVersion, location, publicGalleryName, options)
	if err != nil {
...
func (client *CommunityGalleriesClient) getCreateRequest(ctx context.Context, apiVersion string, location string, publicGalleryName string, _ *CommunityGalleriesClientGetOptions) (*policy.Request, error) {
