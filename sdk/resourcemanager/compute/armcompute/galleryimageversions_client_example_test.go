...
func ExampleGalleryImageVersionsClient_BeginCreateOrUpdate_createOrUpdateASimpleGalleryImageVersionUsingManagedImageAsSource() {
	...
	poller, err := clientFactory.NewGalleryImageVersionsClient().BeginCreateOrUpdate(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryImageName", "1.0.0", armcompute.GalleryImageVersion{
...
func ExampleGalleryImageVersionsClient_BeginDelete() {
	...
	poller, err := clientFactory.NewGalleryImageVersionsClient().BeginDelete(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryImageName", "1.0.0", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
...
func ExampleGalleryImageVersionsClient_Get_getAGalleryImageVersion() {
	...
	res, err := clientFactory.NewGalleryImageVersionsClient().Get(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryImageName", "1.0.0", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleGalleryImageVersionsClient_Get_getAGalleryImageVersionWithReplicationStatus() {
	...
	res, err := clientFactory.NewGalleryImageVersionsClient().Get(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryImageName", "1.0.0", &armcompute.GalleryImageVersionsClientGetOptions{
...
func ExampleGalleryImageVersionsClient_NewListByGalleryImagePager() {
	...
	pager := clientFactory.NewGalleryImageVersionsClient().NewListByGalleryImagePager("2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryImageName", nil)
	for pager.More() {
...
func ExampleGalleryImageVersionsClient_BeginUpdate_updateASimpleGalleryImageVersionManagedImageAsSource() {
	...
	poller, err := clientFactory.NewGalleryImageVersionsClient().BeginUpdate(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryImageName", "1.0.0", armcompute.GalleryImageVersionUpdate{
		Properties: &armcompute.GalleryImageVersionProperties{
			PublishingProfile: &armcompute.GalleryImageVersionPublishingProfile{
				TargetRegions: []*armcompute.TargetRegion{
					{
