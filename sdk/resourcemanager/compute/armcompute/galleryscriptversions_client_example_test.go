...
func ExampleGalleryScriptVersionsClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewGalleryScriptVersionsClient().BeginCreateOrUpdate(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryScriptName", "1.0.0", armcompute.GalleryScriptVersion{
...
func ExampleGalleryScriptVersionsClient_BeginDelete() {
	...
	poller, err := clientFactory.NewGalleryScriptVersionsClient().BeginDelete(ctx, "2025-03-03", "myResourceGroupName", "myGalleryName", "myGalleryScriptName", "1.0.0", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
...
func ExampleGalleryScriptVersionsClient_Get_getAGalleryScriptVersion() {
	...
	res, err := clientFactory.NewGalleryScriptVersionsClient().Get(ctx, "2025-03-03", "myResourceGroupName", "myGalleryName", "myGalleryScriptName", "1.0.0", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleGalleryScriptVersionsClient_NewListByGalleryScriptPager() {
	...
	pager := clientFactory.NewGalleryScriptVersionsClient().NewListByGalleryScriptPager("2025-03-03", "myResourceGroupName", "myGalleryName", "myGalleryScriptName", nil)
	for pager.More() {
...
func ExampleGalleryScriptVersionsClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewGalleryScriptVersionsClient().BeginUpdate(ctx, "2025-03-03", "myResourceGroupName", "myGalleryName", "myGalleryScriptName", "1.0.0", armcompute.GalleryScriptVersionUpdate{
		Properties: &armcompute.GalleryScriptVersionProperties{
			PublishingProfile: &armcompute.GalleryScriptVersionPublishingProfile{
				Source: &armcompute.ScriptSource{
					ScriptLink: to.Ptr("https://mystorageaccount.blob.core.windows.net/mycontainer/myScript.ps1?{sasKey}"),
