...
func ExampleSharedGalleryImagesClient_Get() {
	...
	res, err := clientFactory.NewSharedGalleryImagesClient().Get(ctx, "2025-03-03", "myLocation", "galleryUniqueName", "myGalleryImageName", nil)
	if err != nil {
...
func ExampleSharedGalleryImagesClient_NewListPager() {
	...
	pager := clientFactory.NewSharedGalleryImagesClient().NewListPager("2025-03-03", "myLocation", "galleryUniqueName", nil)
	for pager.More() {
