...
func ExampleDiskAccessesClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewDiskAccessesClient().BeginCreateOrUpdate(ctx, "2025-01-02", "myResourceGroup", "myDiskAccess", armcompute.DiskAccess{
...
func ExampleDiskAccessesClient_BeginDelete() {
	...
	poller, err := clientFactory.NewDiskAccessesClient().BeginDelete(ctx, "2025-01-02", "myResourceGroup", "myDiskAccess", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armcompute.DiskAccessesClientDeleteResponse{
	// }
}
...
func ExampleDiskAccessesClient_BeginDeleteAPrivateEndpointConnection() {
	...
	poller, err := clientFactory.NewDiskAccessesClient().BeginDeleteAPrivateEndpointConnection(ctx, "2025-01-02", "myResourceGroup", "myDiskAccess", "myPrivateEndpointConnection", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armcompute.DiskAccessesClientDeleteAPrivateEndpointConnectionResponse{
	// }
}
...
func ExampleDiskAccessesClient_Get_getInformationAboutADiskAccessResource() {
	...
	res, err := clientFactory.NewDiskAccessesClient().Get(ctx, "2025-01-02", "myResourceGroup", "myDiskAccess", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleDiskAccessesClient_GetAPrivateEndpointConnection() {
	...
	res, err := clientFactory.NewDiskAccessesClient().GetAPrivateEndpointConnection(ctx, "2025-01-02", "myResourceGroup", "myDiskAccess", "myPrivateEndpointConnection", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleDiskAccessesClient_GetPrivateLinkResources() {
	...
	res, err := clientFactory.NewDiskAccessesClient().GetPrivateLinkResources(ctx, "2025-01-02", "myResourceGroup", "myDiskAccess", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleDiskAccessesClient_NewListPager() {
	...
	pager := clientFactory.NewDiskAccessesClient().NewListPager("2025-01-02", nil)
	for pager.More() {
...
func ExampleDiskAccessesClient_NewListByResourceGroupPager() {
	...
	pager := clientFactory.NewDiskAccessesClient().NewListByResourceGroupPager("2025-01-02", "myResourceGroup", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armcompute.DiskAccessesClientListByResourceGroupResponse{
		// 	DiskAccessList: armcompute.DiskAccessList{
		// 		Value: []*armcompute.DiskAccess{
		// 			{
		// 				Properties: &armcompute.DiskAccessProperties{
...
func ExampleDiskAccessesClient_NewListPrivateEndpointConnectionsPager() {
	...
	pager := clientFactory.NewDiskAccessesClient().NewListPrivateEndpointConnectionsPager("2025-01-02", "myResourceGroup", "myDiskAccess", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armcompute.DiskAccessesClientListPrivateEndpointConnectionsResponse{
...
func ExampleDiskAccessesClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewDiskAccessesClient().BeginUpdate(ctx, "2025-01-02", "myResourceGroup", "myDiskAccess", armcompute.DiskAccessUpdate{
		Tags: map[string]*string{
			"department": to.Ptr("Development"),
			"project":    to.Ptr("PrivateEndpoints"),
		},
...
func ExampleDiskAccessesClient_BeginUpdateAPrivateEndpointConnection() {
	...
	poller, err := clientFactory.NewDiskAccessesClient().BeginUpdateAPrivateEndpointConnection(ctx, "2025-01-02", "myResourceGroup", "myDiskAccess", "myPrivateEndpointConnection", armcompute.PrivateEndpointConnection{
		Properties: &armcompute.PrivateEndpointConnectionProperties{
			PrivateLinkServiceConnectionState: &armcompute.PrivateLinkServiceConnectionState{
				Status:      to.Ptr(armcompute.PrivateEndpointServiceConnectionStatusApproved),
