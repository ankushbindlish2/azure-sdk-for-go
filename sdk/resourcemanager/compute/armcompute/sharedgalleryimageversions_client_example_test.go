...
func ExampleSharedGalleryImageVersionsClient_Get() {
	...
	res, err := clientFactory.NewSharedGalleryImageVersionsClient().Get(ctx, "2025-03-03", "myLocation", "galleryUniqueName", "myGalleryImageName", "myGalleryImageVersionName", nil)
	if err != nil {
...
func ExampleSharedGalleryImageVersionsClient_NewListPager() {
	...
	pager := clientFactory.NewSharedGalleryImageVersionsClient().NewListPager("2025-03-03", "myLocation", "galleryUniqueName", "myGalleryImageName", nil)
	for pager.More() {
