...
//     method.
func (client *GalleryScriptVersionsClient) BeginCreateOrUpdate(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, galleryScriptVersionName string, galleryScriptVersion GalleryScriptVersion, options *GalleryScriptVersionsClientBeginCreateOrUpdateOptions) (*runtime.Poller[GalleryScriptVersionsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdate(ctx, apiVersion, resourceGroupName, galleryName, galleryScriptName, galleryScriptVersionName, galleryScriptVersion, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
func (client *GalleryScriptVersionsClient) createOrUpdate(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, galleryScriptVersionName string, galleryScriptVersion GalleryScriptVersion, options *GalleryScriptVersionsClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "GalleryScriptVersionsClient.BeginCreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, apiVersion, resourceGroupName, galleryName, galleryScriptName, galleryScriptVersionName, galleryScriptVersion, options)
	if err != nil {
		return nil, err
	}
...
func (client *GalleryScriptVersionsClient) createOrUpdateCreateRequest(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, galleryScriptVersionName string, galleryScriptVersion GalleryScriptVersion, _ *GalleryScriptVersionsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
//     method.
func (client *GalleryScriptVersionsClient) BeginDelete(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, galleryScriptVersionName string, options *GalleryScriptVersionsClientBeginDeleteOptions) (*runtime.Poller[GalleryScriptVersionsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteOperation(ctx, apiVersion, resourceGroupName, galleryName, galleryScriptName, galleryScriptVersionName, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
func (client *GalleryScriptVersionsClient) deleteOperation(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, galleryScriptVersionName string, options *GalleryScriptVersionsClientBeginDeleteOptions) (*http.Response, error) {
	var err error
	const operationName = "GalleryScriptVersionsClient.BeginDelete"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.deleteCreateRequest(ctx, apiVersion, resourceGroupName, galleryName, galleryScriptName, galleryScriptVersionName, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *GalleryScriptVersionsClient) deleteCreateRequest(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, galleryScriptVersionName string, _ *GalleryScriptVersionsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/scripts/{galleryScriptName}/versions/{galleryScriptVersionName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *GalleryScriptVersionsClient) Get(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, galleryScriptVersionName string, options *GalleryScriptVersionsClientGetOptions) (GalleryScriptVersionsClientGetResponse, error) {
	var err error
	const operationName = "GalleryScriptVersionsClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, apiVersion, resourceGroupName, galleryName, galleryScriptName, galleryScriptVersionName, options)
	if err != nil {
...
func (client *GalleryScriptVersionsClient) getCreateRequest(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, galleryScriptVersionName string, _ *GalleryScriptVersionsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/scripts/{galleryScriptName}/versions/{galleryScriptVersionName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *GalleryScriptVersionsClient) NewListByGalleryScriptPager(apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, options *GalleryScriptVersionsClientListByGalleryScriptOptions) *runtime.Pager[GalleryScriptVersionsClientListByGalleryScriptResponse] {
	return runtime.NewPager(runtime.PagingHandler[GalleryScriptVersionsClientListByGalleryScriptResponse]{
		...
		Fetcher: func(ctx context.Context, page *GalleryScriptVersionsClientListByGalleryScriptResponse) (GalleryScriptVersionsClientListByGalleryScriptResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listByGalleryScriptCreateRequest(ctx, apiVersion, resourceGroupName, galleryName, galleryScriptName, options)
			}, nil)
			if err != nil {
...
func (client *GalleryScriptVersionsClient) listByGalleryScriptCreateRequest(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, _ *GalleryScriptVersionsClientListByGalleryScriptOptions) (*policy.Request, error) {
...
//     method.
func (client *GalleryScriptVersionsClient) BeginUpdate(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, galleryScriptVersionName string, galleryScriptVersion GalleryScriptVersionUpdate, options *GalleryScriptVersionsClientBeginUpdateOptions) (*runtime.Poller[GalleryScriptVersionsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.update(ctx, apiVersion, resourceGroupName, galleryName, galleryScriptName, galleryScriptVersionName, galleryScriptVersion, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
func (client *GalleryScriptVersionsClient) update(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, galleryScriptVersionName string, galleryScriptVersion GalleryScriptVersionUpdate, options *GalleryScriptVersionsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "GalleryScriptVersionsClient.BeginUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.updateCreateRequest(ctx, apiVersion, resourceGroupName, galleryName, galleryScriptName, galleryScriptVersionName, galleryScriptVersion, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *GalleryScriptVersionsClient) updateCreateRequest(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, galleryScriptVersionName string, galleryScriptVersion GalleryScriptVersionUpdate, _ *GalleryScriptVersionsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/galleries/{galleryName}/scripts/{galleryScriptName}/versions/{galleryScriptVersionName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
