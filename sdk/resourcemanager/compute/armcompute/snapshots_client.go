...
//     method.
func (client *SnapshotsClient) BeginCreateOrUpdate(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, snapshot Snapshot, options *SnapshotsClientBeginCreateOrUpdateOptions) (*runtime.Poller[SnapshotsClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdate(ctx, apiVersion, resourceGroupName, snapshotName, snapshot, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
func (client *SnapshotsClient) createOrUpdate(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, snapshot Snapshot, options *SnapshotsClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "SnapshotsClient.BeginCreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, apiVersion, resourceGroupName, snapshotName, snapshot, options)
	if err != nil {
		return nil, err
	}
...
func (client *SnapshotsClient) createOrUpdateCreateRequest(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, snapshot Snapshot, _ *SnapshotsClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *SnapshotsClient) BeginDelete(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, options *SnapshotsClientBeginDeleteOptions) (*runtime.Poller[SnapshotsClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteOperation(ctx, apiVersion, resourceGroupName, snapshotName, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
func (client *SnapshotsClient) deleteOperation(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, options *SnapshotsClientBeginDeleteOptions) (*http.Response, error) {
	var err error
	const operationName = "SnapshotsClient.BeginDelete"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.deleteCreateRequest(ctx, apiVersion, resourceGroupName, snapshotName, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *SnapshotsClient) deleteCreateRequest(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, _ *SnapshotsClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/snapshots/{snapshotName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
func (client *SnapshotsClient) Get(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, options *SnapshotsClientGetOptions) (SnapshotsClientGetResponse, error) {
	var err error
	const operationName = "SnapshotsClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, apiVersion, resourceGroupName, snapshotName, options)
	if err != nil {
...
func (client *SnapshotsClient) getCreateRequest(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, _ *SnapshotsClientGetOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/snapshots/{snapshotName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
...
//     method.
func (client *SnapshotsClient) BeginGrantAccess(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, grantAccessData GrantAccessData, options *SnapshotsClientBeginGrantAccessOptions) (*runtime.Poller[SnapshotsClientGrantAccessResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.grantAccess(ctx, apiVersion, resourceGroupName, snapshotName, grantAccessData, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
func (client *SnapshotsClient) grantAccess(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, grantAccessData GrantAccessData, options *SnapshotsClientBeginGrantAccessOptions) (*http.Response, error) {
	var err error
	const operationName = "SnapshotsClient.BeginGrantAccess"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.grantAccessCreateRequest(ctx, apiVersion, resourceGroupName, snapshotName, grantAccessData, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *SnapshotsClient) grantAccessCreateRequest(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, grantAccessData GrantAccessData, _ *SnapshotsClientBeginGrantAccessOptions) (*policy.Request, error) {
...
func (client *SnapshotsClient) NewListPager(apiVersion string, options *SnapshotsClientListOptions) *runtime.Pager[SnapshotsClientListResponse] {
...
func (client *SnapshotsClient) listCreateRequest(ctx context.Context, apiVersion string, _ *SnapshotsClientListOptions) (*policy.Request, error) {
...
//     method.
func (client *SnapshotsClient) NewListByResourceGroupPager(apiVersion string, resourceGroupName string, options *SnapshotsClientListByResourceGroupOptions) *runtime.Pager[SnapshotsClientListByResourceGroupResponse] {
...
func (client *SnapshotsClient) listByResourceGroupCreateRequest(ctx context.Context, apiVersion string, resourceGroupName string, _ *SnapshotsClientListByResourceGroupOptions) (*policy.Request, error) {
...
//     method.
func (client *SnapshotsClient) BeginRevokeAccess(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, options *SnapshotsClientBeginRevokeAccessOptions) (*runtime.Poller[SnapshotsClientRevokeAccessResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.revokeAccess(ctx, apiVersion, resourceGroupName, snapshotName, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
func (client *SnapshotsClient) revokeAccess(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, options *SnapshotsClientBeginRevokeAccessOptions) (*http.Response, error) {
	var err error
	const operationName = "SnapshotsClient.BeginRevokeAccess"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.revokeAccessCreateRequest(ctx, apiVersion, resourceGroupName, snapshotName, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *SnapshotsClient) revokeAccessCreateRequest(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, _ *SnapshotsClientBeginRevokeAccessOptions) (*policy.Request, error) {
...
func (client *SnapshotsClient) BeginUpdate(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, snapshot SnapshotUpdate, options *SnapshotsClientBeginUpdateOptions) (*runtime.Poller[SnapshotsClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.update(ctx, apiVersion, resourceGroupName, snapshotName, snapshot, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
func (client *SnapshotsClient) update(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, snapshot SnapshotUpdate, options *SnapshotsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
	const operationName = "SnapshotsClient.BeginUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.updateCreateRequest(ctx, apiVersion, resourceGroupName, snapshotName, snapshot, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *SnapshotsClient) updateCreateRequest(ctx context.Context, apiVersion string, resourceGroupName string, snapshotName string, snapshot SnapshotUpdate, _ *SnapshotsClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/snapshots/{snapshotName}"
	if client.subscriptionID == "" {
		return nil, errors.New("parameter client.subscriptionID cannot be empty")
	}
