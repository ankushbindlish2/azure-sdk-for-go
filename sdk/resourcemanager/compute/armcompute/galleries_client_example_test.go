...
func ExampleGalleriesClient_BeginCreateOrUpdate_createACommunityGallery() {
	...
	poller, err := clientFactory.NewGalleriesClient().BeginCreateOrUpdate(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", armcompute.Gallery{
...
func ExampleGalleriesClient_BeginDelete() {
	...
	poller, err := clientFactory.NewGalleriesClient().BeginDelete(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armcompute.GalleriesClientDeleteResponse{
	// }
}
...
func ExampleGalleriesClient_Get_getACommunityGallery() {
	...
	res, err := clientFactory.NewGalleriesClient().Get(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleGalleriesClient_Get_getAGalleryWithExpandSharingProfileGroups() {
	...
	res, err := clientFactory.NewGalleriesClient().Get(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", &armcompute.GalleriesClientGetOptions{
...
func ExampleGalleriesClient_NewListPager() {
	...
	pager := clientFactory.NewGalleriesClient().NewListPager("2025-03-03", nil)
	for pager.More() {
...
func ExampleGalleriesClient_NewListByResourceGroupPager() {
	...
	pager := clientFactory.NewGalleriesClient().NewListByResourceGroupPager("2025-03-03", "myResourceGroup", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
		...
		// If the HTTP response code is 200 as defined in example definition, your page structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
		// page = armcompute.GalleriesClientListByResourceGroupResponse{
		// 	GalleryList: armcompute.GalleryList{
		// 		Value: []*armcompute.Gallery{
		// 			{
		// 				Properties: &armcompute.GalleryProperties{
		...
		// 			},
		// 		},
		// 		NextLink: to.Ptr("http://svchost:99/subscriptions/subscriptionId/resourceGroups/myResourceGroup/providers/Microsoft.Compute/galleries?$skiptoken=token/Subscriptions/subscriptionId/ResourceGroups/myResourceGroup/galleries/myGalleryName"),
		// 	},
		// }
	}
}
...
func ExampleGalleriesClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewGalleriesClient().BeginUpdate(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", armcompute.GalleryUpdate{
		Properties: &armcompute.GalleryProperties{
			Description: to.Ptr("This is the gallery description."),
		},
	}, nil)
