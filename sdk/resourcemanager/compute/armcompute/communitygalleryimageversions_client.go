...
//     method.
func (client *CommunityGalleryImageVersionsClient) Get(ctx context.Context, apiVersion string, location string, publicGalleryName string, galleryImageName string, galleryImageVersionName string, options *CommunityGalleryImageVersionsClientGetOptions) (CommunityGalleryImageVersionsClientGetResponse, error) {
	var err error
	const operationName = "CommunityGalleryImageVersionsClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, apiVersion, location, publicGalleryName, galleryImageName, galleryImageVersionName, options)
	if err != nil {
...
func (client *CommunityGalleryImageVersionsClient) getCreateRequest(ctx context.Context, apiVersion string, location string, publicGalleryName string, galleryImageName string, galleryImageVersionName string, _ *CommunityGalleryImageVersionsClientGetOptions) (*policy.Request, error) {
...
//     method.
func (client *CommunityGalleryImageVersionsClient) NewListPager(apiVersion string, location string, publicGalleryName string, galleryImageName string, options *CommunityGalleryImageVersionsClientListOptions) *runtime.Pager[CommunityGalleryImageVersionsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[CommunityGalleryImageVersionsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *CommunityGalleryImageVersionsClientListResponse) (CommunityGalleryImageVersionsClientListResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listCreateRequest(ctx, apiVersion, location, publicGalleryName, galleryImageName, options)
			}, nil)
			if err != nil {
...
func (client *CommunityGalleryImageVersionsClient) listCreateRequest(ctx context.Context, apiVersion string, location string, publicGalleryName string, galleryImageName string, _ *CommunityGalleryImageVersionsClientListOptions) (*policy.Request, error) {
