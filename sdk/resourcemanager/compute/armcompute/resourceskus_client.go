...
func (client *ResourceSKUsClient) NewListPager(apiVersion string, options *ResourceSKUsClientListOptions) *runtime.Pager[ResourceSKUsClientListResponse] {
...
func (client *ResourceSKUsClient) listCreateRequest(ctx context.Context, apiVersion string, options *ResourceSKUsClientListOptions) (*policy.Request, error) {
