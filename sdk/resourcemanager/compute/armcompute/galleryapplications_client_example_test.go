...
func ExampleGalleryApplicationsClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewGalleryApplicationsClient().BeginCreateOrUpdate(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryApplicationName", armcompute.GalleryApplication{
...
func ExampleGalleryApplicationsClient_BeginDelete() {
	...
	poller, err := clientFactory.NewGalleryApplicationsClient().BeginDelete(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryApplicationName", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
...
func ExampleGalleryApplicationsClient_Get() {
	...
	res, err := clientFactory.NewGalleryApplicationsClient().Get(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryApplicationName", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleGalleryApplicationsClient_NewListByGalleryPager() {
	...
	pager := clientFactory.NewGalleryApplicationsClient().NewListByGalleryPager("2025-03-03", "myResourceGroup", "myGalleryName", nil)
	for pager.More() {
...
func ExampleGalleryApplicationsClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewGalleryApplicationsClient().BeginUpdate(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryApplicationName", armcompute.GalleryApplicationUpdate{
		Properties: &armcompute.GalleryApplicationProperties{
			Description:         to.Ptr("This is the gallery application description."),
			Eula:                to.Ptr("This is the gallery application EULA."),
			PrivacyStatementURI: to.Ptr("myPrivacyStatementUri}"),
