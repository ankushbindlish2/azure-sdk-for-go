...
func ExampleSnapshotsClient_BeginCreateOrUpdate_createASnapshotByImportingAnUnmanagedBlobFromADifferentSubscription() {
	...
	poller, err := clientFactory.NewSnapshotsClient().BeginCreateOrUpdate(ctx, "2025-01-02", "myResourceGroup", "mySnapshot1", armcompute.Snapshot{
...
func ExampleSnapshotsClient_BeginCreateOrUpdate_createASnapshotFromAnExistingSnapshotInTheSameOrADifferentSubscriptionInADifferentRegionWithQuickerCopySpeed() {
	...
	poller, err := clientFactory.NewSnapshotsClient().BeginCreateOrUpdate(ctx, "2025-01-02", "myResourceGroup", "mySnapshot2", armcompute.Snapshot{
		Location: to.Ptr("West US"),
		Properties: &armcompute.SnapshotProperties{
			CreationData: &armcompute.CreationData{
...
func ExampleSnapshotsClient_BeginCreateOrUpdate_createASnapshotFromAnElasticSanVolumeSnapshot() {
	...
	poller, err := clientFactory.NewSnapshotsClient().BeginCreateOrUpdate(ctx, "2025-01-02", "myResourceGroup", "mySnapshot", armcompute.Snapshot{
		Location: to.Ptr("West US"),
		Properties: &armcompute.SnapshotProperties{
			CreationData: &armcompute.CreationData{
...
func ExampleSnapshotsClient_BeginDelete() {
	...
	poller, err := clientFactory.NewSnapshotsClient().BeginDelete(ctx, "2025-01-02", "myResourceGroup", "mySnapshot", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
...
func ExampleSnapshotsClient_Get_getInformationAboutASnapshot() {
	...
	res, err := clientFactory.NewSnapshotsClient().Get(ctx, "2025-01-02", "myResourceGroup", "mySnapshot", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleSnapshotsClient_Get_getInformationAboutAnIncrementalSnapshot() {
	...
	res, err := clientFactory.NewSnapshotsClient().Get(ctx, "2025-01-02", "myResourceGroup", "myIncrementalSnapshot", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleSnapshotsClient_BeginGrantAccess() {
	...
	poller, err := clientFactory.NewSnapshotsClient().BeginGrantAccess(ctx, "2025-01-02", "myResourceGroup", "mySnapshot", armcompute.GrantAccessData{
...
func ExampleSnapshotsClient_NewListPager() {
	...
	pager := clientFactory.NewSnapshotsClient().NewListPager("2025-01-02", nil)
	for pager.More() {
...
func ExampleSnapshotsClient_NewListByResourceGroupPager() {
	...
	pager := clientFactory.NewSnapshotsClient().NewListByResourceGroupPager("2025-01-02", "myResourceGroup", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
func ExampleSnapshotsClient_BeginRevokeAccess() {
	...
	poller, err := clientFactory.NewSnapshotsClient().BeginRevokeAccess(ctx, "2025-01-02", "myResourceGroup", "mySnapshot", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
...
func ExampleSnapshotsClient_BeginUpdate_updateASnapshot() {
	...
	poller, err := clientFactory.NewSnapshotsClient().BeginUpdate(ctx, "2025-01-02", "myResourceGroup", "mySnapshot", armcompute.SnapshotUpdate{
