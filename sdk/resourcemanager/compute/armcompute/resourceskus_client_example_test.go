...
func ExampleResourceSKUsClient_NewListPager_listsAllAvailableResourceSkUs() {
	...
	pager := clientFactory.NewResourceSKUsClient().NewListPager("2021-07-01", nil)
	for pager.More() {
...
func ExampleResourceSKUsClient_NewListPager_listsAllAvailableResourceSkUsForTheSpecifiedRegion() {
	...
	pager := clientFactory.NewResourceSKUsClient().NewListPager("2021-07-01", &armcompute.ResourceSKUsClientListOptions{
