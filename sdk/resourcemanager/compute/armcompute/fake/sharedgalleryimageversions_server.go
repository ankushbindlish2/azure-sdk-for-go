...
type SharedGalleryImageVersionsServer struct {
	...
	Get func(ctx context.Context, apiVersion string, location string, galleryUniqueName string, galleryImageName string, galleryImageVersionName string, options *armcompute.SharedGalleryImageVersionsClientGetOptions) (resp azfake.Responder[armcompute.SharedGalleryImageVersionsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method SharedGalleryImageVersionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(apiVersion string, location string, galleryUniqueName string, galleryImageName string, options *armcompute.SharedGalleryImageVersionsClientListOptions) (resp azfake.PagerResponder[armcompute.SharedGalleryImageVersionsClientListResponse])
}
...
func (s *SharedGalleryImageVersionsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.Get(req.Context(), apiVersionParam, locationParam, galleryUniqueNameParam, galleryImageNameParam, galleryImageVersionNameParam, nil)
...
func (s *SharedGalleryImageVersionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		resp := s.srv.NewListPager(apiVersionParam, locationParam, galleryUniqueNameParam, galleryImageNameParam, options)
		newListPager = &resp
