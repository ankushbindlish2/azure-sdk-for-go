...
type SoftDeletedResourceServer struct {
	...
	NewListByArtifactNamePager func(apiVersion string, resourceGroupName string, galleryName string, artifactType string, artifactName string, options *armcompute.SoftDeletedResourceClientListByArtifactNameOptions) (resp azfake.PagerResponder[armcompute.SoftDeletedResourceClientListByArtifactNameResponse])
}
...
func (s *SoftDeletedResourceServerTransport) dispatchNewListByArtifactNamePager(req *http.Request) (*http.Response, error) {
	...
	if newListByArtifactNamePager == nil {
		...
		resp := s.srv.NewListByArtifactNamePager(apiVersionParam, resourceGroupNameParam, galleryNameParam, artifactTypeParam, artifactNameParam, nil)
