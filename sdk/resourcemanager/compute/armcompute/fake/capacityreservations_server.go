...
func (c *CapacityReservationsServerTransport) dispatchNewListByCapacityReservationGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByCapacityReservationGroupPager == nil {
		...
		var options *armcompute.CapacityReservationsClientListByCapacityReservationGroupOptions
		if expandParam != nil {
			options = &armcompute.CapacityReservationsClientListByCapacityReservationGroupOptions{
				Expand: expandParam,
			}
		}
		resp := c.srv.NewListByCapacityReservationGroupPager(resourceGroupNameParam, capacityReservationGroupNameParam, options)
