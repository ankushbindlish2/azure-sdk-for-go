...
type CommunityGalleryImageVersionsServer struct {
	...
	Get func(ctx context.Context, apiVersion string, location string, publicGalleryName string, galleryImageName string, galleryImageVersionName string, options *armcompute.CommunityGalleryImageVersionsClientGetOptions) (resp azfake.Responder[armcompute.CommunityGalleryImageVersionsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method CommunityGalleryImageVersionsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(apiVersion string, location string, publicGalleryName string, galleryImageName string, options *armcompute.CommunityGalleryImageVersionsClientListOptions) (resp azfake.PagerResponder[armcompute.CommunityGalleryImageVersionsClientListResponse])
}
...
func (c *CommunityGalleryImageVersionsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := c.srv.Get(req.Context(), apiVersionParam, locationParam, publicGalleryNameParam, galleryImageNameParam, galleryImageVersionNameParam, nil)
...
func (c *CommunityGalleryImageVersionsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		resp := c.srv.NewListPager(apiVersionParam, locationParam, publicGalleryNameParam, galleryImageNameParam, nil)
		newListPager = &resp
