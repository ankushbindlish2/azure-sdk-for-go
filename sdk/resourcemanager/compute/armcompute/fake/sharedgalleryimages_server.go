...
type SharedGalleryImagesServer struct {
	...
	Get func(ctx context.Context, apiVersion string, location string, galleryUniqueName string, galleryImageName string, options *armcompute.SharedGalleryImagesClientGetOptions) (resp azfake.Responder[armcompute.SharedGalleryImagesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method SharedGalleryImagesClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(apiVersion string, location string, galleryUniqueName string, options *armcompute.SharedGalleryImagesClientListOptions) (resp azfake.PagerResponder[armcompute.SharedGalleryImagesClientListResponse])
}
...
func (s *SharedGalleryImagesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.Get(req.Context(), apiVersionParam, locationParam, galleryUniqueNameParam, galleryImageNameParam, nil)
...
func (s *SharedGalleryImagesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		resp := s.srv.NewListPager(apiVersionParam, locationParam, galleryUniqueNameParam, options)
		newListPager = &resp
