...
type SharedGalleriesServer struct {
	...
	Get func(ctx context.Context, apiVersion string, location string, galleryUniqueName string, options *armcompute.SharedGalleriesClientGetOptions) (resp azfake.Responder[armcompute.SharedGalleriesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method SharedGalleriesClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(apiVersion string, location string, options *armcompute.SharedGalleriesClientListOptions) (resp azfake.PagerResponder[armcompute.SharedGalleriesClientListResponse])
}
...
func (s *SharedGalleriesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := s.srv.Get(req.Context(), apiVersionParam, locationParam, galleryUniqueNameParam, nil)
...
func (s *SharedGalleriesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		resp := s.srv.NewListPager(apiVersionParam, locationParam, options)
		newListPager = &resp
