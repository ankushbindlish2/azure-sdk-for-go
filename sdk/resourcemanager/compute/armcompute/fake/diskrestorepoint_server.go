...
func (d *DiskRestorePointServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.Get(req.Context(), apiVersionParam, resourceGroupNameParam, restorePointCollectionNameParam, vmRestorePointNameParam, diskRestorePointNameParam, nil)
...
func (d *DiskRestorePointServerTransport) dispatchBeginGrantAccess(req *http.Request) (*http.Response, error) {
	...
	if beginGrantAccess == nil {
		...
		respr, errRespr := d.srv.BeginGrantAccess(req.Context(), apiVersionParam, resourceGroupNameParam, restorePointCollectionNameParam, vmRestorePointNameParam, diskRestorePointNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
...
func (d *DiskRestorePointServerTransport) dispatchNewListByRestorePointPager(req *http.Request) (*http.Response, error) {
	...
	if newListByRestorePointPager == nil {
		...
		resp := d.srv.NewListByRestorePointPager(apiVersionParam, resourceGroupNameParam, restorePointCollectionNameParam, vmRestorePointNameParam, nil)
...
func (d *DiskRestorePointServerTransport) dispatchBeginRevokeAccess(req *http.Request) (*http.Response, error) {
	...
	if beginRevokeAccess == nil {
		...
		respr, errRespr := d.srv.BeginRevokeAccess(req.Context(), apiVersionParam, resourceGroupNameParam, restorePointCollectionNameParam, vmRestorePointNameParam, diskRestorePointNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
