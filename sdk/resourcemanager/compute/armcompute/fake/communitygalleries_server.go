...
type CommunityGalleriesServer struct {
	...
	Get func(ctx context.Context, apiVersion string, location string, publicGalleryName string, options *armcompute.CommunityGalleriesClientGetOptions) (resp azfake.Responder[armcompute.CommunityGalleriesClientGetResponse], errResp azfake.ErrorResponder)
}
...
func (c *CommunityGalleriesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := c.srv.Get(req.Context(), apiVersionParam, locationParam, publicGalleryNameParam, nil)
