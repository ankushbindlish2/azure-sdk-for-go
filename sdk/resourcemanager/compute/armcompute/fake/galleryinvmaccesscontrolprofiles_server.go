...
func (g *GalleryInVMAccessControlProfilesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := g.srv.BeginCreateOrUpdate(req.Context(), apiVersionParam, resourceGroupNameParam, galleryNameParam, inVMAccessControlProfileNameParam, body, nil)
...
func (g *GalleryInVMAccessControlProfilesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := g.srv.BeginDelete(req.Context(), apiVersionParam, resourceGroupNameParam, galleryNameParam, inVMAccessControlProfileNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (g *GalleryInVMAccessControlProfilesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := g.srv.Get(req.Context(), apiVersionParam, resourceGroupNameParam, galleryNameParam, inVMAccessControlProfileNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (g *GalleryInVMAccessControlProfilesServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		respr, errRespr := g.srv.BeginUpdate(req.Context(), apiVersionParam, resourceGroupNameParam, galleryNameParam, inVMAccessControlProfileNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdate = &respr
