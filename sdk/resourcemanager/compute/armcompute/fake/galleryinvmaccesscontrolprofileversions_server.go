...
func (g *GalleryInVMAccessControlProfileVersionsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := g.srv.BeginCreateOrUpdate(req.Context(), apiVersionParam, resourceGroupNameParam, galleryNameParam, inVMAccessControlProfileNameParam, inVMAccessControlProfileVersionNameParam, body, nil)
...
func (g *GalleryInVMAccessControlProfileVersionsServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := g.srv.BeginDelete(req.Context(), apiVersionParam, resourceGroupNameParam, galleryNameParam, inVMAccessControlProfileNameParam, inVMAccessControlProfileVersionNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (g *GalleryInVMAccessControlProfileVersionsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := g.srv.Get(req.Context(), apiVersionParam, resourceGroupNameParam, galleryNameParam, inVMAccessControlProfileNameParam, inVMAccessControlProfileVersionNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (g *GalleryInVMAccessControlProfileVersionsServerTransport) dispatchNewListByGalleryInVMAccessControlProfilePager(req *http.Request) (*http.Response, error) {
	...
	if newListByGalleryInVMAccessControlProfilePager == nil {
		...
		resp := g.srv.NewListByGalleryInVMAccessControlProfilePager(apiVersionParam, resourceGroupNameParam, galleryNameParam, inVMAccessControlProfileNameParam, nil)
...
func (g *GalleryInVMAccessControlProfileVersionsServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		respr, errRespr := g.srv.BeginUpdate(req.Context(), apiVersionParam, resourceGroupNameParam, galleryNameParam, inVMAccessControlProfileNameParam, inVMAccessControlProfileVersionNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdate = &respr
