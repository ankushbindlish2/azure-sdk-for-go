...
type GalleryScriptsServer struct {
	...
	BeginCreateOrUpdate func(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, galleryScript armcompute.GalleryScript, options *armcompute.GalleryScriptsClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armcompute.GalleryScriptsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method GalleryScriptsClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, options *armcompute.GalleryScriptsClientBeginDeleteOptions) (resp azfake.PollerResponder[armcompute.GalleryScriptsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method GalleryScriptsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, options *armcompute.GalleryScriptsClientGetOptions) (resp azfake.Responder[armcompute.GalleryScriptsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByGalleryPager is the fake for method GalleryScriptsClient.NewListByGalleryPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByGalleryPager func(apiVersion string, resourceGroupName string, galleryName string, options *armcompute.GalleryScriptsClientListByGalleryOptions) (resp azfake.PagerResponder[armcompute.GalleryScriptsClientListByGalleryResponse])

	// BeginUpdate is the fake for method GalleryScriptsClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginUpdate func(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, galleryScriptName string, galleryScript armcompute.GalleryScriptUpdate, options *armcompute.GalleryScriptsClientBeginUpdateOptions) (resp azfake.PollerResponder[armcompute.GalleryScriptsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (g *GalleryScriptsServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		respr, errRespr := g.srv.BeginCreateOrUpdate(req.Context(), apiVersionParam, resourceGroupNameParam, galleryNameParam, galleryScriptNameParam, body, nil)
...
func (g *GalleryScriptsServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := g.srv.BeginDelete(req.Context(), apiVersionParam, resourceGroupNameParam, galleryNameParam, galleryScriptNameParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (g *GalleryScriptsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := g.srv.Get(req.Context(), apiVersionParam, resourceGroupNameParam, galleryNameParam, galleryScriptNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
...
func (g *GalleryScriptsServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		respr, errRespr := g.srv.BeginUpdate(req.Context(), apiVersionParam, resourceGroupNameParam, galleryNameParam, galleryScriptNameParam, body, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginUpdate = &respr
