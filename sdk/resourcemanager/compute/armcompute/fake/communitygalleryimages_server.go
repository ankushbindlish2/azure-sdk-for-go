...
type CommunityGalleryImagesServer struct {
	...
	Get func(ctx context.Context, apiVersion string, location string, publicGalleryName string, galleryImageName string, options *armcompute.CommunityGalleryImagesClientGetOptions) (resp azfake.Responder[armcompute.CommunityGalleryImagesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method CommunityGalleryImagesClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(apiVersion string, location string, publicGalleryName string, options *armcompute.CommunityGalleryImagesClientListOptions) (resp azfake.PagerResponder[armcompute.CommunityGalleryImagesClientListResponse])
}
...
func (c *CommunityGalleryImagesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := c.srv.Get(req.Context(), apiVersionParam, locationParam, publicGalleryNameParam, galleryImageNameParam, nil)
...
func (c *CommunityGalleryImagesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		resp := c.srv.NewListPager(apiVersionParam, locationParam, publicGalleryNameParam, nil)
		newListPager = &resp
