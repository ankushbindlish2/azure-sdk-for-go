...
func ExampleDiskEncryptionSetsClient_BeginCreateOrUpdate_createADiskEncryptionSet() {
	...
	poller, err := clientFactory.NewDiskEncryptionSetsClient().BeginCreateOrUpdate(ctx, "2025-01-02", "myResourceGroup", "myDiskEncryptionSet", armcompute.DiskEncryptionSet{
...
func ExampleDiskEncryptionSetsClient_BeginDelete() {
	...
	poller, err := clientFactory.NewDiskEncryptionSetsClient().BeginDelete(ctx, "2025-01-02", "myResourceGroup", "myDiskEncryptionSet", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
...
func ExampleDiskEncryptionSetsClient_Get_getInformationAboutADiskEncryptionSet() {
	...
	res, err := clientFactory.NewDiskEncryptionSetsClient().Get(ctx, "2025-01-02", "myResourceGroup", "myDiskEncryptionSet", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleDiskEncryptionSetsClient_NewListPager() {
	...
	pager := clientFactory.NewDiskEncryptionSetsClient().NewListPager("2025-01-02", nil)
	for pager.More() {
...
func ExampleDiskEncryptionSetsClient_NewListAssociatedResourcesPager() {
	...
	pager := clientFactory.NewDiskEncryptionSetsClient().NewListAssociatedResourcesPager("2025-01-02", "myResourceGroup", "myDiskEncryptionSet", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
func ExampleDiskEncryptionSetsClient_NewListByResourceGroupPager() {
	...
	pager := clientFactory.NewDiskEncryptionSetsClient().NewListByResourceGroupPager("2025-01-02", "myResourceGroup", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
func ExampleDiskEncryptionSetsClient_BeginUpdate_updateADiskEncryptionSet() {
	...
	poller, err := clientFactory.NewDiskEncryptionSetsClient().BeginUpdate(ctx, "2025-01-02", "myResourceGroup", "myDiskEncryptionSet", armcompute.DiskEncryptionSetUpdate{
