...
//     method.
func (client *CommunityGalleryImagesClient) Get(ctx context.Context, apiVersion string, location string, publicGalleryName string, galleryImageName string, options *CommunityGalleryImagesClientGetOptions) (CommunityGalleryImagesClientGetResponse, error) {
	var err error
	const operationName = "CommunityGalleryImagesClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, apiVersion, location, publicGalleryName, galleryImageName, options)
	if err != nil {
...
func (client *CommunityGalleryImagesClient) getCreateRequest(ctx context.Context, apiVersion string, location string, publicGalleryName string, galleryImageName string, _ *CommunityGalleryImagesClientGetOptions) (*policy.Request, error) {
...
//     method.
func (client *CommunityGalleryImagesClient) NewListPager(apiVersion string, location string, publicGalleryName string, options *CommunityGalleryImagesClientListOptions) *runtime.Pager[CommunityGalleryImagesClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[CommunityGalleryImagesClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *CommunityGalleryImagesClientListResponse) (CommunityGalleryImagesClientListResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listCreateRequest(ctx, apiVersion, location, publicGalleryName, options)
			}, nil)
			if err != nil {
...
func (client *CommunityGalleryImagesClient) listCreateRequest(ctx context.Context, apiVersion string, location string, publicGalleryName string, _ *CommunityGalleryImagesClientListOptions) (*policy.Request, error) {
