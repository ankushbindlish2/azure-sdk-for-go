...
func ExampleGalleryApplicationVersionsClient_BeginCreateOrUpdate() {
	...
	poller, err := clientFactory.NewGalleryApplicationVersionsClient().BeginCreateOrUpdate(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryApplicationName", "1.0.0", armcompute.GalleryApplicationVersion{
...
func ExampleGalleryApplicationVersionsClient_BeginDelete() {
	...
	poller, err := clientFactory.NewGalleryApplicationVersionsClient().BeginDelete(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryApplicationName", "1.0.0", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armcompute.GalleryApplicationVersionsClientDeleteResponse{
	// }
}
...
func ExampleGalleryApplicationVersionsClient_Get_getAGalleryApplicationVersion() {
	...
	res, err := clientFactory.NewGalleryApplicationVersionsClient().Get(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryApplicationName", "1.0.0", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleGalleryApplicationVersionsClient_Get_getAGalleryApplicationVersionWithReplicationStatus() {
	...
	res, err := clientFactory.NewGalleryApplicationVersionsClient().Get(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryApplicationName", "1.0.0", &armcompute.GalleryApplicationVersionsClientGetOptions{
...
func ExampleGalleryApplicationVersionsClient_NewListByGalleryApplicationPager() {
	...
	pager := clientFactory.NewGalleryApplicationVersionsClient().NewListByGalleryApplicationPager("2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryApplicationName", nil)
	for pager.More() {
		...
		// page = armcompute.GalleryApplicationVersionsClientListByGalleryApplicationResponse{
...
func ExampleGalleryApplicationVersionsClient_BeginUpdate() {
	...
	poller, err := clientFactory.NewGalleryApplicationVersionsClient().BeginUpdate(ctx, "2025-03-03", "myResourceGroup", "myGalleryName", "myGalleryApplicationName", "1.0.0", armcompute.GalleryApplicationVersionUpdate{
		Properties: &armcompute.GalleryApplicationVersionProperties{
			PublishingProfile: &armcompute.GalleryApplicationVersionPublishingProfile{
				Source: &armcompute.UserArtifactSource{
					MediaLink: to.Ptr("https://mystorageaccount.blob.core.windows.net/mycontainer/package.zip?{sasKey}"),
