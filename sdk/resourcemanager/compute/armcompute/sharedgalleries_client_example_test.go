...
func ExampleSharedGalleriesClient_Get() {
	...
	res, err := clientFactory.NewSharedGalleriesClient().Get(ctx, "2025-03-03", "myLocation", "galleryUniqueName", nil)
	if err != nil {
...
func ExampleSharedGalleriesClient_NewListPager() {
	...
	pager := clientFactory.NewSharedGalleriesClient().NewListPager("2025-03-03", "myLocation", nil)
	for pager.More() {
