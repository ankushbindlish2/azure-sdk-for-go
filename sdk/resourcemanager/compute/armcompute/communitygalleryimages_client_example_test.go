...
func ExampleCommunityGalleryImagesClient_Get() {
	...
	res, err := clientFactory.NewCommunityGalleryImagesClient().Get(ctx, "2025-03-03", "myLocation", "publicGalleryName", "myGalleryImageName", nil)
	if err != nil {
...
func ExampleCommunityGalleryImagesClient_NewListPager() {
	...
	pager := clientFactory.NewCommunityGalleryImagesClient().NewListPager("2025-03-03", "myLocation", "publicGalleryName", nil)
	for pager.More() {
