...
func (client *SharedGalleriesClient) Get(ctx context.Context, apiVersion string, location string, galleryUniqueName string, options *SharedGalleriesClientGetOptions) (SharedGalleriesClientGetResponse, error) {
	var err error
	const operationName = "SharedGalleriesClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, apiVersion, location, galleryUniqueName, options)
	if err != nil {
...
func (client *SharedGalleriesClient) getCreateRequest(ctx context.Context, apiVersion string, location string, galleryUniqueName string, _ *SharedGalleriesClientGetOptions) (*policy.Request, error) {
...
//     method.
func (client *SharedGalleriesClient) NewListPager(apiVersion string, location string, options *SharedGalleriesClientListOptions) *runtime.Pager[SharedGalleriesClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[SharedGalleriesClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *SharedGalleriesClientListResponse) (SharedGalleriesClientListResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listCreateRequest(ctx, apiVersion, location, options)
			}, nil)
			if err != nil {
...
func (client *SharedGalleriesClient) listCreateRequest(ctx context.Context, apiVersion string, location string, options *SharedGalleriesClientListOptions) (*policy.Request, error) {
