...
func ExampleCommunityGalleryImageVersionsClient_Get() {
	...
	res, err := clientFactory.NewCommunityGalleryImageVersionsClient().Get(ctx, "2025-03-03", "myLocation", "publicGalleryName", "myGalleryImageName", "myGalleryImageVersionName", nil)
	if err != nil {
...
func ExampleCommunityGalleryImageVersionsClient_NewListPager() {
	...
	pager := clientFactory.NewCommunityGalleryImageVersionsClient().NewListPager("2025-03-03", "myLocation", "publicGalleryName", "myGalleryImageName", nil)
	for pager.More() {
