...
//     method.
func (client *SharedGalleryImageVersionsClient) Get(ctx context.Context, apiVersion string, location string, galleryUniqueName string, galleryImageName string, galleryImageVersionName string, options *SharedGalleryImageVersionsClientGetOptions) (SharedGalleryImageVersionsClientGetResponse, error) {
	var err error
	const operationName = "SharedGalleryImageVersionsClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, apiVersion, location, galleryUniqueName, galleryImageName, galleryImageVersionName, options)
	if err != nil {
...
func (client *SharedGalleryImageVersionsClient) getCreateRequest(ctx context.Context, apiVersion string, location string, galleryUniqueName string, galleryImageName string, galleryImageVersionName string, _ *SharedGalleryImageVersionsClientGetOptions) (*policy.Request, error) {
...
//     method.
func (client *SharedGalleryImageVersionsClient) NewListPager(apiVersion string, location string, galleryUniqueName string, galleryImageName string, options *SharedGalleryImageVersionsClientListOptions) *runtime.Pager[SharedGalleryImageVersionsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[SharedGalleryImageVersionsClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *SharedGalleryImageVersionsClientListResponse) (SharedGalleryImageVersionsClientListResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listCreateRequest(ctx, apiVersion, location, galleryUniqueName, galleryImageName, options)
			}, nil)
			if err != nil {
...
func (client *SharedGalleryImageVersionsClient) listCreateRequest(ctx context.Context, apiVersion string, location string, galleryUniqueName string, galleryImageName string, options *SharedGalleryImageVersionsClientListOptions) (*policy.Request, error) {
