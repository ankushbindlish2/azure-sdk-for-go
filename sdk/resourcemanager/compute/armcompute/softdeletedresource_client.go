...
//     method.
func (client *SoftDeletedResourceClient) NewListByArtifactNamePager(apiVersion string, resourceGroupName string, galleryName string, artifactType string, artifactName string, options *SoftDeletedResourceClientListByArtifactNameOptions) *runtime.Pager[SoftDeletedResourceClientListByArtifactNameResponse] {
	return runtime.NewPager(runtime.PagingHandler[SoftDeletedResourceClientListByArtifactNameResponse]{
		...
		Fetcher: func(ctx context.Context, page *SoftDeletedResourceClientListByArtifactNameResponse) (SoftDeletedResourceClientListByArtifactNameResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listByArtifactNameCreateRequest(ctx, apiVersion, resourceGroupName, galleryName, artifactType, artifactName, options)
			}, nil)
			if err != nil {
...
func (client *SoftDeletedResourceClient) listByArtifactNameCreateRequest(ctx context.Context, apiVersion string, resourceGroupName string, galleryName string, artifactType string, artifactName string, _ *SoftDeletedResourceClientListByArtifactNameOptions) (*policy.Request, error) {
