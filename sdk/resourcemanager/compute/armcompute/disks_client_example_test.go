...
func ExampleDisksClient_BeginCreateOrUpdate_createAManagedDiskWithAvailabilityPolicy() {
	...
	poller, err := clientFactory.NewDisksClient().BeginCreateOrUpdate(ctx, "2025-01-02", "myResourceGroup", "myDisk", armcompute.Disk{
...
func ExampleDisksClient_BeginCreateOrUpdate_createAManagedDiskFromAnExistingManagedDiskInTheSameOrDifferentSubscription() {
	...
	poller, err := clientFactory.NewDisksClient().BeginCreateOrUpdate(ctx, "2025-01-02", "myResourceGroup", "myDisk2", armcompute.Disk{
		Location: to.Ptr("West US"),
		Properties: &armcompute.DiskProperties{
			CreationData: &armcompute.CreationData{
				CreateOption:     to.Ptr(armcompute.DiskCreateOptionCopy),
...
func ExampleDisksClient_BeginCreateOrUpdate_createAManagedDiskWithPremiumV2AccountType() {
	...
	poller, err := clientFactory.NewDisksClient().BeginCreateOrUpdate(ctx, "2025-01-02", "myResourceGroup", "myPremiumV2Disk", armcompute.Disk{
		Location: to.Ptr("West US"),
		SKU: &armcompute.DiskSKU{
...
func ExampleDisksClient_BeginCreateOrUpdate_createAManagedDiskWithUltraAccountTypeWithReadOnlyPropertySet() {
	...
	poller, err := clientFactory.NewDisksClient().BeginCreateOrUpdate(ctx, "2025-01-02", "myResourceGroup", "myUltraReadOnlyDisk", armcompute.Disk{
		Location: to.Ptr("West US"),
		SKU: &armcompute.DiskSKU{
			Name: to.Ptr(armcompute.DiskStorageAccountTypesUltraSSDLRS),
		},
...
func ExampleDisksClient_BeginDelete() {
	...
	poller, err := clientFactory.NewDisksClient().BeginDelete(ctx, "2025-01-02", "myResourceGroup", "myDisk", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
...
func ExampleDisksClient_Get() {
	...
	res, err := clientFactory.NewDisksClient().Get(ctx, "2025-01-02", "myResourceGroup", "myManagedDisk", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	// You could use response here. We use blank identifier for just demo purposes.
...
func ExampleDisksClient_BeginGrantAccess_getASasOnAManagedDisk() {
	...
	poller, err := clientFactory.NewDisksClient().BeginGrantAccess(ctx, "2025-01-02", "myResourceGroup", "myDisk", armcompute.GrantAccessData{
...
func ExampleDisksClient_NewListPager() {
	...
	pager := clientFactory.NewDisksClient().NewListPager("2025-01-02", nil)
	for pager.More() {
...
func ExampleDisksClient_NewListByResourceGroupPager() {
	...
	pager := clientFactory.NewDisksClient().NewListByResourceGroupPager("2025-01-02", "myResourceGroup", nil)
	for pager.More() {
		page, err := pager.NextPage(ctx)
		if err != nil {
			log.Fatalf("failed to advance page: %v", err)
...
func ExampleDisksClient_BeginRevokeAccess() {
	...
	poller, err := clientFactory.NewDisksClient().BeginRevokeAccess(ctx, "2025-01-02", "myResourceGroup", "myDisk", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
...
func ExampleDisksClient_BeginUpdate_createOrUpdateABurstingEnabledManagedDisk() {
	...
	poller, err := clientFactory.NewDisksClient().BeginUpdate(ctx, "2025-01-02", "myResourceGroup", "myDisk", armcompute.DiskUpdate{
