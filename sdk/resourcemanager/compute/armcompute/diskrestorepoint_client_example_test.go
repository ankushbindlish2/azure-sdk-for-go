...
// Generated from example definition: 2025-01-02/diskRestorePointExamples/DiskRestorePoint_Get.json
func ExampleDiskRestorePointClient_Get_getAnIncrementalDiskRestorePointResource() {
	...
	res, err := clientFactory.NewDiskRestorePointClient().Get(ctx, "2025-01-02", "myResourceGroup", "rpc", "vmrp", "TestDisk45ceb03433006d1baee0_b70cd924-3362-4a80-93c2-9415eaa12745", nil)
	if err != nil {
...
// Generated from example definition: 2025-01-02/diskRestorePointExamples/DiskRestorePoint_Get_WhenSourceResourceIsFromDifferentRegion.json
...
// Generated from example definition: 2025-01-02/diskRestorePointExamples/DiskRestorePoint_BeginGetAccess.json
func ExampleDiskRestorePointClient_BeginGrantAccess() {
	...
	poller, err := clientFactory.NewDiskRestorePointClient().BeginGrantAccess(ctx, "2025-01-02", "myResourceGroup", "rpc", "vmrp", "TestDisk45ceb03433006d1baee0_b70cd924-3362-4a80-93c2-9415eaa12745", armcompute.GrantAccessData{
...
// Generated from example definition: 2025-01-02/diskRestorePointExamples/DiskRestorePoint_ListByVmRestorePoint.json
func ExampleDiskRestorePointClient_NewListByRestorePointPager() {
	...
	pager := clientFactory.NewDiskRestorePointClient().NewListByRestorePointPager("2025-01-02", "myResourceGroup", "rpc", "vmrp", nil)
	for pager.More() {
...
// Generated from example definition: 2025-01-02/diskRestorePointExamples/DiskRestorePoint_EndGetAccess.json
func ExampleDiskRestorePointClient_BeginRevokeAccess() {
	...
	poller, err := clientFactory.NewDiskRestorePointClient().BeginRevokeAccess(ctx, "2025-01-02", "myResourceGroup", "rpc", "vmrp", "TestDisk45ceb03433006d1baee0_b70cd924-3362-4a80-93c2-9415eaa12745", nil)
	if err != nil {
		log.Fatalf("failed to finish the request: %v", err)
	}
	res, err := poller.PollUntilDone(ctx, nil)
