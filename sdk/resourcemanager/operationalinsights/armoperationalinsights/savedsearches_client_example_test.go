...
func ExampleSavedSearchesClient_NewListByWorkspacePager() {
	cred, err := azidentity.NewDefaultAzureCredential(nil)
	if err != nil {
		log.Fatalf("failed to obtain a credential: %v", err)
	}
	...
	pager := clientFactory.NewSavedSearchesClient().NewListByWorkspacePager("TestRG", "TestWS", nil)
	for pager.More() {
		...
		// page = armoperationalinsights.SavedSearchesClientListByWorkspaceResponse{
