...
// SummaryLogsClientBeginCreateOrUpdateOptions contains the optional parameters for the SummaryLogsClient.BeginCreateOrUpdate
// method.
type SummaryLogsClientBeginCreateOrUpdateOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// SummaryLogsClientBeginDeleteOptions contains the optional parameters for the SummaryLogsClient.BeginDelete method.
type SummaryLogsClientBeginDeleteOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// SummaryLogsClientBeginRetryBinOptions contains the optional parameters for the SummaryLogsClient.BeginRetryBin method.
type SummaryLogsClientBeginRetryBinOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// SummaryLogsClientBeginStartOptions contains the optional parameters for the SummaryLogsClient.BeginStart method.
type SummaryLogsClientBeginStartOptions struct {
	// Resumes the long-running operation from the provided token.
	ResumeToken string
}

// SummaryLogsClientGetOptions contains the optional parameters for the SummaryLogsClient.Get method.
type SummaryLogsClientGetOptions struct {
	// placeholder for future optional parameters
}

// SummaryLogsClientListByWorkspaceOptions contains the optional parameters for the SummaryLogsClient.NewListByWorkspacePager
// method.
type SummaryLogsClientListByWorkspaceOptions struct {
	// placeholder for future optional parameters
}

// SummaryLogsClientStopOptions contains the optional parameters for the SummaryLogsClient.Stop method.
type SummaryLogsClientStopOptions struct {
	// placeholder for future optional parameters
}
