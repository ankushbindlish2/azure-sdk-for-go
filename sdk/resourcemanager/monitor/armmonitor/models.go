...
// ErrorDetailAutoGenerated - Describes details of an error response.
...
// ErrorDetailAutoGenerated3 - The error detail.
...
// ErrorResponseAutoGenerated2 - Describes the format of Error response.
...
type ErrorResponseAutoGenerated4 struct {
	...
	// READ-ONLY; The error details.
	Details []*ErrorResponseAutoGenerated4
...
// ErrorResponseAutoGenerated5 - Common error response for all Azure Resource Manager APIs to return error details for failed
// operations. (This also follows the OData error response format.).
