...
- Operation `*MetricAlertsStatusClient.List` has supported pagination, use `*MetricAlertsStatusClient.NewListPager` instead.
- Operation `*MetricAlertsStatusClient.ListByName` has supported pagination, use `*MetricAlertsStatusClient.NewListByNamePager` instead.
- Operation `*PrivateEndpointConnectionsClient.ListByPrivateLinkScope` has supported pagination, use `*PrivateEndpointConnectionsClient.NewListByPrivateLinkScopePager` instead.
...
- New field `ActionGroupID`, `ActionProperties`, `IncidentReceivers`, `WebhookProperties` in struct `ActionGroup`
