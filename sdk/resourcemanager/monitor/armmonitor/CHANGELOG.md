...
- Type of `ErrorContract.Error` has been changed from `*ErrorResponse` to `*ErrorResponseAutoGenerated4`
- Type of `ErrorDetailAutoGenerated.AdditionalInfo` has been changed from `[]*ErrorAdditionalInfo` to `[]*ErrorDetailAdditionalInfoItem`
- Type of `ErrorResponseAutoGenerated2.Error` has been changed from `*ErrorDetailAutoGenerated` to `*ErrorResponseError`
...
- Field `Details` of struct `ErrorDetailAutoGenerated` has been removed
...
- New field `ActionProperties` in struct `ActionGroupAutoGenerated`
...
- New field `Identity` in struct `ResourceAutoGenerated2`
- New field `SystemData` in struct `ResourceAutoGenerated3`
