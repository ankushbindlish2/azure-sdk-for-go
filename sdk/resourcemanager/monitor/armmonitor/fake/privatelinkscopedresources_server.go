...
func (p *PrivateLinkScopedResourcesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if privateLinkScopedResourcesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = privateLinkScopedResourcesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (p *PrivateLinkScopedResourcesServerTransport) dispatchNewListByPrivateLinkScopePager(req *http.Request) (*http.Response, error) {
	...
	if newListByPrivateLinkScopePager == nil {
		...
		var options *armmonitor.PrivateLinkScopedResourcesClientListByPrivateLinkScopeOptions
		if kindParam != nil {
			options = &armmonitor.PrivateLinkScopedResourcesClientListByPrivateLinkScopeOptions{
				Kind: kindParam,
			}
		}
		resp := p.srv.NewListByPrivateLinkScopePager(resourceGroupNameParam, scopeNameParam, options)
...
// set this to conditionally intercept incoming requests to PrivateLinkScopedResourcesServerTransport
var privateLinkScopedResourcesServerTransportInterceptor interface {
