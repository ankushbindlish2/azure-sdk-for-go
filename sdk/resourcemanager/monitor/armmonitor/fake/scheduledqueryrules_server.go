...
func (s *ScheduledQueryRulesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if scheduledQueryRulesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = scheduledQueryRulesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ScheduledQueryRulesServerTransport
var scheduledQueryRulesServerTransportInterceptor interface {
