...
type DataCollectionRuleAssociationsServer struct {
	...
	Create func(ctx context.Context, resourceURI string, associationName string, body armmonitor.DataCollectionRuleAssociationProxyOnlyResource, options *armmonitor.DataCollectionRuleAssociationsClientCreateOptions) (resp azfake.Responder[armmonitor.DataCollectionRuleAssociationsClientCreateResponse], errResp azfake.ErrorResponder)
...
func (d *DataCollectionRuleAssociationsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if dataCollectionRuleAssociationsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = dataCollectionRuleAssociationsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
			...
			case "DataCollectionRuleAssociationsClient.NewListByDataCollectionEndpointPager":
				res.resp, res.err = d.dispatchNewListByDataCollectionEndpointPager(req)
			case "DataCollectionRuleAssociationsClient.NewListByResourcePager":
				res.resp, res.err = d.dispatchNewListByResourcePager(req)
			case "DataCollectionRuleAssociationsClient.NewListByRulePager":
				res.resp, res.err = d.dispatchNewListByRulePager(req)
			default:
...
func (d *DataCollectionRuleAssociationsServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.Create(req.Context(), resourceURIParam, associationNameParam, body, nil)
...
func (d *DataCollectionRuleAssociationsServerTransport) dispatchNewListByRulePager(req *http.Request) (*http.Response, error) {
	...
	if newListByRulePager == nil {
		...
		var options *armmonitor.DataCollectionRuleAssociationsClientListByRuleOptions
		if skipTokenParam != nil || topParam != nil {
			options = &armmonitor.DataCollectionRuleAssociationsClientListByRuleOptions{
				SkipToken: skipTokenParam,
				Top:       topParam,
			}
		}
		resp := d.srv.NewListByRulePager(resourceGroupNameParam, dataCollectionRuleNameParam, options)
...
// set this to conditionally intercept incoming requests to DataCollectionRuleAssociationsServerTransport
var dataCollectionRuleAssociationsServerTransportInterceptor interface {
