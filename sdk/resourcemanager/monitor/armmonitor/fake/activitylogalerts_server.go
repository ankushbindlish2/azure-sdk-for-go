...
func (a *ActivityLogAlertsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if activityLogAlertsServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = activityLogAlertsServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
// set this to conditionally intercept incoming requests to ActivityLogAlertsServerTransport
var activityLogAlertsServerTransportInterceptor interface {
