...
type DataCollectionRulesServer struct {
	...
	Create func(ctx context.Context, resourceGroupName string, dataCollectionRuleName string, body armmonitor.DataCollectionRuleResource, options *armmonitor.DataCollectionRulesClientCreateOptions) (resp azfake.Responder[armmonitor.DataCollectionRulesClientCreateResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, resourceGroupName string, dataCollectionRuleName string, body armmonitor.ResourceForUpdate, options *armmonitor.DataCollectionRulesClientUpdateOptions) (resp azfake.Responder[armmonitor.DataCollectionRulesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (d *DataCollectionRulesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		var res result
		if dataCollectionRulesServerTransportInterceptor != nil {
			res.resp, res.err, intercepted = dataCollectionRulesServerTransportInterceptor.Do(req)
		}
		if !intercepted {
			switch method {
...
func (d *DataCollectionRulesServerTransport) dispatchCreate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.Create(req.Context(), resourceGroupNameParam, dataCollectionRuleNameParam, body, nil)
...
func (d *DataCollectionRulesServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := d.srv.Update(req.Context(), resourceGroupNameParam, dataCollectionRuleNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
// set this to conditionally intercept incoming requests to DataCollectionRulesServerTransport
var dataCollectionRulesServerTransportInterceptor interface {
