...
## 3.0.0-beta.1 (2026-04-10)
### Breaking Changes

- Type of `APIError.SystemData` has been changed from `*SystemData` to `*SystemDataAutoGenerated`
- Type of `DatabaseMigrationSQLDb.SystemData` has been changed from `*SystemData` to `*SystemDataAutoGenerated`
- Type of `DatabaseMigrationSQLMi.SystemData` has been changed from `*SystemData` to `*SystemDataAutoGenerated`
- Type of `DatabaseMigrationSQLVM.SystemData` has been changed from `*SystemData` to `*SystemDataAutoGenerated`
...
- Type of `SQLMigrationService.SystemData` has been changed from `*SystemData` to `*SystemDataAutoGenerated`
