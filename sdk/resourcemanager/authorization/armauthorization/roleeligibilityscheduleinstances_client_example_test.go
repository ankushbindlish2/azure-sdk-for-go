...
// Generated from example definition: 2024-09-01-preview/GetRoleEligibilityScheduleInstanceByName.json
func ExampleRoleEligibilityScheduleInstancesClient_Get() {
	...
	// res = armauthorization.RoleEligibilityScheduleInstancesClientGetResponse{
	// 	RoleEligibilityScheduleInstance: &armauthorization.RoleEligibilityScheduleInstance{
...
// Generated from example definition: 2024-09-01-preview/GetRoleEligibilityScheduleInstancesByScope.json
func ExampleRoleEligibilityScheduleInstancesClient_NewListForScopePager() {
	...
	pager := clientFactory.NewRoleEligibilityScheduleInstancesClient().NewListForScopePager("providers/Microsoft.Subscription/subscriptions/dfa2a084-766f-4003-8ae1-c4aeb893a99f", &armauthorization.RoleEligibilityScheduleInstancesClientListForScopeOptions{
	...
	for pager.More() {
		...
		// page = armauthorization.RoleEligibilityScheduleInstancesClientListForScopeResponse{
		// 	RoleEligibilityScheduleInstanceListResult: armauthorization.RoleEligibilityScheduleInstanceListResult{
