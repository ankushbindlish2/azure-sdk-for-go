...
// Generated from example definition: 2024-09-01-preview/GetRoleEligibilityScheduleByName.json
func ExampleRoleEligibilitySchedulesClient_Get() {
	...
	// 			CreatedOn: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2020-09-09T21:33:06.3Z"); return t}()),
	// 			EndDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2021-09-09T21:32:28.49Z"); return t}()),
...
// Generated from example definition: 2024-09-01-preview/GetRoleEligibilitySchedulesByScope.json
func ExampleRoleEligibilitySchedulesClient_NewListForScopePager() {
	...
	pager := clientFactory.NewRoleEligibilitySchedulesClient().NewListForScopePager("providers/Microsoft.Subscription/subscriptions/dfa2a084-766f-4003-8ae1-c4aeb893a99f", &armauthorization.RoleEligibilitySchedulesClientListForScopeOptions{
	...
	for pager.More() {
		...
		// page = armauthorization.RoleEligibilitySchedulesClientListForScopeResponse{
		// 	RoleEligibilityScheduleListResult: armauthorization.RoleEligibilityScheduleListResult{
