...
// Generated from example definition: 2024-09-01-preview/GetRoleAssignmentScheduleInstanceByName.json
func ExampleRoleAssignmentScheduleInstancesClient_Get() {
	...
	// res = armauthorization.RoleAssignmentScheduleInstancesClientGetResponse{
	// 	RoleAssignmentScheduleInstance: &armauthorization.RoleAssignmentScheduleInstance{
	...
	// 			EndDateTime: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2020-09-10T05:35:17.91Z"); return t}()),
...
// Generated from example definition: 2024-09-01-preview/GetRoleAssignmentScheduleInstancesByScope.json
func ExampleRoleAssignmentScheduleInstancesClient_NewListForScopePager() {
	...
	pager := clientFactory.NewRoleAssignmentScheduleInstancesClient().NewListForScopePager("providers/Microsoft.Subscription/subscriptions/dfa2a084-766f-4003-8ae1-c4aeb893a99f", &armauthorization.RoleAssignmentScheduleInstancesClientListForScopeOptions{
	...
	for pager.More() {
		...
		// page = armauthorization.RoleAssignmentScheduleInstancesClientListForScopeResponse{
		// 	RoleAssignmentScheduleInstanceListResult: armauthorization.RoleAssignmentScheduleInstanceListResult{
