...
// Generated from example definition: 2024-09-01-preview/GetRoleAssignmentScheduleByName.json
func ExampleRoleAssignmentSchedulesClient_Get() {
	...
	// 			UpdatedOn: to.Ptr(func() time.Time { t, _ := time.Parse(time.RFC3339Nano, "2020-09-09T21:35:27.91Z"); return t}()),
	// 		},
	// 	},
	// }
}

// Generated from example definition: 2024-09-01-preview/GetRoleAssignmentSchedulesByScope.json
func ExampleRoleAssignmentSchedulesClient_NewListForScopePager() {
	...
	pager := clientFactory.NewRoleAssignmentSchedulesClient().NewListForScopePager("providers/Microsoft.Subscription/subscriptions/dfa2a084-766f-4003-8ae1-c4aeb893a99f", &armauthorization.RoleAssignmentSchedulesClientListForScopeOptions{
	...
	for pager.More() {
		...
		// page = armauthorization.RoleAssignmentSchedulesClientListForScopeResponse{
		// 	RoleAssignmentScheduleListResult: armauthorization.RoleAssignmentScheduleListResult{
