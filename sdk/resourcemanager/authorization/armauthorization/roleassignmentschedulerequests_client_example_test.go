...
// Generated from example definition: 2024-09-01-preview/CancelRoleAssignmentScheduleRequestByName.json
func ExampleRoleAssignmentScheduleRequestsClient_Cancel() {
	...
	res, err := clientFactory.NewRoleAssignmentScheduleRequestsClient().Cancel(ctx, "providers/Microsoft.Subscription/subscriptions/dfa2a084-766f-4003-8ae1-c4aeb893a99f", "fea7a502-9a96-4806-a26f-eee560e52045", nil)
	if err != nil {
	...
	// res = armauthorization.RoleAssignmentScheduleRequestsClientCancelResponse{
	// }
}

// Generated from example definition: 2024-09-01-preview/PutRoleAssignmentScheduleRequest.json
...
// Generated from example definition: 2024-09-01-preview/GetRoleAssignmentScheduleRequestByName.json
func ExampleRoleAssignmentScheduleRequestsClient_Get() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armauthorization.RoleAssignmentScheduleRequestsClientGetResponse{
...
// Generated from example definition: 2024-09-01-preview/GetRoleAssignmentScheduleRequestByScope.json
func ExampleRoleAssignmentScheduleRequestsClient_NewListForScopePager() {
	...
	pager := clientFactory.NewRoleAssignmentScheduleRequestsClient().NewListForScopePager("providers/Microsoft.Subscription/subscriptions/dfa2a084-766f-4003-8ae1-c4aeb893a99f", &armauthorization.RoleAssignmentScheduleRequestsClientListForScopeOptions{
	...
	for pager.More() {
		...
		// page = armauthorization.RoleAssignmentScheduleRequestsClientListForScopeResponse{
		// 	RoleAssignmentScheduleRequestListResult: armauthorization.RoleAssignmentScheduleRequestListResult{
...
// Generated from example definition: 2024-09-01-preview/ValidateRoleAssignmentScheduleRequestByName.json
func ExampleRoleAssignmentScheduleRequestsClient_Validate() {
	...
	_ = res
	// If the HTTP response code is 200 as defined in example definition, your response structure would look as follows. Please pay attention that all the values in the output are fake values for just demo purposes.
	// res = armauthorization.RoleAssignmentScheduleRequestsClientValidateResponse{
	// 	RoleAssignmentScheduleRequest: &armauthorization.RoleAssignmentScheduleRequest{
	// 		Name: to.Ptr("fea7a502-9a96-4806-a26f-eee560e52045"),
	// 		Type: to.Ptr("Microsoft.Authorization/RoleAssignmentScheduleRequests"),
	// 		ID: to.Ptr("/subscriptions/dfa2a084-766f-4003-8ae1-c4aeb893a99f/providers/Microsoft.Authorization/RoleAssignmentScheduleRequests/fea7a502-9a96-4806-a26f-eee560e52045"),
