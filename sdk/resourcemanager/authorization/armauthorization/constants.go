...
// CommonUserType - The type of user.
type CommonUserType string

const (
	// CommonUserTypeGroup - Group
	CommonUserTypeGroup CommonUserType = "Group"
	// CommonUserTypeServicePrincipal - ServicePrincipal
	CommonUserTypeServicePrincipal CommonUserType = "ServicePrincipal"
	// CommonUserTypeUser - User
	CommonUserTypeUser CommonUserType = "User"
)

// PossibleCommonUserTypeValues returns the possible values for the CommonUserType const type.
func PossibleCommonUserTypeValues() []CommonUserType {
	return []CommonUserType{
		CommonUserTypeGroup,
		CommonUserTypeServicePrincipal,
		CommonUserTypeUser,
	}
}
