...
// OnBuildError - If there is a customizer error and this field is set to 'cleanup', the build VM and associated network resources
// will be cleaned up. This is the default behavior. If there is a customizer error and
