...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "AppResiliencyClient":
		initServer(s, &s.trAppResiliencyServer, func() *AppResiliencyServerTransport { return NewAppResiliencyServerTransport(&s.srv.AppResiliencyServer) })
		resp, err = s.trAppResiliencyServer.Do(req)
	case "AvailableWorkloadProfilesClient":
		initServer(s, &s.trAvailableWorkloadProfilesServer, func() *AvailableWorkloadProfilesServerTransport { return NewAvailableWorkloadProfilesServerTransport(&s.srv.AvailableWorkloadProfilesServer) })
		resp, err = s.trAvailableWorkloadProfilesServer.Do(req)
	case "BillingMetersClient":
		initServer(s, &s.trBillingMetersServer, func() *BillingMetersServerTransport { return NewBillingMetersServerTransport(&s.srv.BillingMetersServer) })
		resp, err = s.trBillingMetersServer.Do(req)
	case "BuildAuthTokenClient":
		initServer(s, &s.trBuildAuthTokenServer, func() *BuildAuthTokenServerTransport { return NewBuildAuthTokenServerTransport(&s.srv.BuildAuthTokenServer) })
	...
	case "BuildsByBuilderResourceClient":
		initServer(s, &s.trBuildsByBuilderResourceServer, func() *BuildsByBuilderResourceServerTransport { return NewBuildsByBuilderResourceServerTransport(&s.srv.BuildsByBuilderResourceServer) })
	...
	case "ConnectedEnvironmentsCertificatesClient":
		initServer(s, &s.trConnectedEnvironmentsCertificatesServer, func() *ConnectedEnvironmentsCertificatesServerTransport { return NewConnectedEnvironmentsCertificatesServerTransport(&s.srv.ConnectedEnvironmentsCertificatesServer) })
		resp, err = s.trConnectedEnvironmentsCertificatesServer.Do(req)
	case "ConnectedEnvironmentsClient":
		initServer(s, &s.trConnectedEnvironmentsServer, func() *ConnectedEnvironmentsServerTransport { return NewConnectedEnvironmentsServerTransport(&s.srv.ConnectedEnvironmentsServer) })
		resp, err = s.trConnectedEnvironmentsServer.Do(req)
	case "ConnectedEnvironmentsDaprComponentsClient":
		initServer(s, &s.trConnectedEnvironmentsDaprComponentsServer, func() *ConnectedEnvironmentsDaprComponentsServerTransport { return NewConnectedEnvironmentsDaprComponentsServerTransport(&s.srv.ConnectedEnvironmentsDaprComponentsServer) })
		resp, err = s.trConnectedEnvironmentsDaprComponentsServer.Do(req)
	case "ConnectedEnvironmentsStoragesClient":
		initServer(s, &s.trConnectedEnvironmentsStoragesServer, func() *ConnectedEnvironmentsStoragesServerTransport { return NewConnectedEnvironmentsStoragesServerTransport(&s.srv.ConnectedEnvironmentsStoragesServer) })
		resp, err = s.trConnectedEnvironmentsStoragesServer.Do(req)
	case "ContainerAppsAPIClient":
		initServer(s, &s.trContainerAppsAPIServer, func() *ContainerAppsAPIServerTransport { return NewContainerAppsAPIServerTransport(&s.srv.ContainerAppsAPIServer) })
		resp, err = s.trContainerAppsAPIServer.Do(req)
	case "ContainerAppsAuthConfigsClient":
		initServer(s, &s.trContainerAppsAuthConfigsServer, func() *ContainerAppsAuthConfigsServerTransport { return NewContainerAppsAuthConfigsServerTransport(&s.srv.ContainerAppsAuthConfigsServer) })
		resp, err = s.trContainerAppsAuthConfigsServer.Do(req)
	case "ContainerAppsBuildsByContainerAppClient":
		initServer(s, &s.trContainerAppsBuildsByContainerAppServer, func() *ContainerAppsBuildsByContainerAppServerTransport { return NewContainerAppsBuildsByContainerAppServerTransport(&s.srv.ContainerAppsBuildsByContainerAppServer) })
		resp, err = s.trContainerAppsBuildsByContainerAppServer.Do(req)
	case "ContainerAppsBuildsClient":
		initServer(s, &s.trContainerAppsBuildsServer, func() *ContainerAppsBuildsServerTransport { return NewContainerAppsBuildsServerTransport(&s.srv.ContainerAppsBuildsServer) })
		resp, err = s.trContainerAppsBuildsServer.Do(req)
	case "ContainerAppsClient":
		initServer(s, &s.trContainerAppsServer, func() *ContainerAppsServerTransport { return NewContainerAppsServerTransport(&s.srv.ContainerAppsServer) })
		resp, err = s.trContainerAppsServer.Do(req)
	case "ContainerAppsDiagnosticsClient":
		initServer(s, &s.trContainerAppsDiagnosticsServer, func() *ContainerAppsDiagnosticsServerTransport { return NewContainerAppsDiagnosticsServerTransport(&s.srv.ContainerAppsDiagnosticsServer) })
		resp, err = s.trContainerAppsDiagnosticsServer.Do(req)
	case "ContainerAppsFunctionsClient":
		initServer(s, &s.trContainerAppsFunctionsServer, func() *ContainerAppsFunctionsServerTransport { return NewContainerAppsFunctionsServerTransport(&s.srv.ContainerAppsFunctionsServer) })
		resp, err = s.trContainerAppsFunctionsServer.Do(req)
	case "ContainerAppsLabelHistoryClient":
		initServer(s, &s.trContainerAppsLabelHistoryServer, func() *ContainerAppsLabelHistoryServerTransport { return NewContainerAppsLabelHistoryServerTransport(&s.srv.ContainerAppsLabelHistoryServer) })
		resp, err = s.trContainerAppsLabelHistoryServer.Do(req)
	case "ContainerAppsPatchesClient":
		initServer(s, &s.trContainerAppsPatchesServer, func() *ContainerAppsPatchesServerTransport { return NewContainerAppsPatchesServerTransport(&s.srv.ContainerAppsPatchesServer) })
		resp, err = s.trContainerAppsPatchesServer.Do(req)
	case "ContainerAppsRevisionFunctionsClient":
		initServer(s, &s.trContainerAppsRevisionFunctionsServer, func() *ContainerAppsRevisionFunctionsServerTransport { return NewContainerAppsRevisionFunctionsServerTransport(&s.srv.ContainerAppsRevisionFunctionsServer) })
		resp, err = s.trContainerAppsRevisionFunctionsServer.Do(req)
	case "ContainerAppsRevisionReplicasClient":
		initServer(s, &s.trContainerAppsRevisionReplicasServer, func() *ContainerAppsRevisionReplicasServerTransport { return NewContainerAppsRevisionReplicasServerTransport(&s.srv.ContainerAppsRevisionReplicasServer) })
		resp, err = s.trContainerAppsRevisionReplicasServer.Do(req)
	case "ContainerAppsRevisionsClient":
		initServer(s, &s.trContainerAppsRevisionsServer, func() *ContainerAppsRevisionsServerTransport { return NewContainerAppsRevisionsServerTransport(&s.srv.ContainerAppsRevisionsServer) })
		resp, err = s.trContainerAppsRevisionsServer.Do(req)
	case "ContainerAppsSessionPoolsClient":
		initServer(s, &s.trContainerAppsSessionPoolsServer, func() *ContainerAppsSessionPoolsServerTransport { return NewContainerAppsSessionPoolsServerTransport(&s.srv.ContainerAppsSessionPoolsServer) })
		resp, err = s.trContainerAppsSessionPoolsServer.Do(req)
	case "ContainerAppsSourceControlsClient":
		initServer(s, &s.trContainerAppsSourceControlsServer, func() *ContainerAppsSourceControlsServerTransport { return NewContainerAppsSourceControlsServerTransport(&s.srv.ContainerAppsSourceControlsServer) })
		resp, err = s.trContainerAppsSourceControlsServer.Do(req)
	case "DaprComponentResiliencyPoliciesClient":
		initServer(s, &s.trDaprComponentResiliencyPoliciesServer, func() *DaprComponentResiliencyPoliciesServerTransport { return NewDaprComponentResiliencyPoliciesServerTransport(&s.srv.DaprComponentResiliencyPoliciesServer) })
		resp, err = s.trDaprComponentResiliencyPoliciesServer.Do(req)
	case "DaprComponentsClient":
		initServer(s, &s.trDaprComponentsServer, func() *DaprComponentsServerTransport { return NewDaprComponentsServerTransport(&s.srv.DaprComponentsServer) })
		resp, err = s.trDaprComponentsServer.Do(req)
	case "DaprSubscriptionsClient":
		initServer(s, &s.trDaprSubscriptionsServer, func() *DaprSubscriptionsServerTransport { return NewDaprSubscriptionsServerTransport(&s.srv.DaprSubscriptionsServer) })
		resp, err = s.trDaprSubscriptionsServer.Do(req)
	case "DotNetComponentsClient":
		initServer(s, &s.trDotNetComponentsServer, func() *DotNetComponentsServerTransport { return NewDotNetComponentsServerTransport(&s.srv.DotNetComponentsServer) })
		resp, err = s.trDotNetComponentsServer.Do(req)
	case "FunctionsExtensionClient":
		initServer(s, &s.trFunctionsExtensionServer, func() *FunctionsExtensionServerTransport { return NewFunctionsExtensionServerTransport(&s.srv.FunctionsExtensionServer) })
	...
	case "JavaComponentsClient":
		initServer(s, &s.trJavaComponentsServer, func() *JavaComponentsServerTransport { return NewJavaComponentsServerTransport(&s.srv.JavaComponentsServer) })
	...
	case "JobsExecutionsClient":
		initServer(s, &s.trJobsExecutionsServer, func() *JobsExecutionsServerTransport { return NewJobsExecutionsServerTransport(&s.srv.JobsExecutionsServer) })
	...
	case "MaintenanceConfigurationsClient":
		initServer(s, &s.trMaintenanceConfigurationsServer, func() *MaintenanceConfigurationsServerTransport { return NewMaintenanceConfigurationsServerTransport(&s.srv.MaintenanceConfigurationsServer) })
		resp, err = s.trMaintenanceConfigurationsServer.Do(req)
	case "ManagedCertificatesClient":
		initServer(s, &s.trManagedCertificatesServer, func() *ManagedCertificatesServerTransport { return NewManagedCertificatesServerTransport(&s.srv.ManagedCertificatesServer) })
		resp, err = s.trManagedCertificatesServer.Do(req)
	case "ManagedEnvironmentDiagnosticsClient":
		initServer(s, &s.trManagedEnvironmentDiagnosticsServer, func() *ManagedEnvironmentDiagnosticsServerTransport { return NewManagedEnvironmentDiagnosticsServerTransport(&s.srv.ManagedEnvironmentDiagnosticsServer) })
		resp, err = s.trManagedEnvironmentDiagnosticsServer.Do(req)
	case "ManagedEnvironmentPrivateEndpointConnectionsClient":
		initServer(s, &s.trManagedEnvironmentPrivateEndpointConnectionsServer, func() *ManagedEnvironmentPrivateEndpointConnectionsServerTransport { return NewManagedEnvironmentPrivateEndpointConnectionsServerTransport(&s.srv.ManagedEnvironmentPrivateEndpointConnectionsServer) })
		resp, err = s.trManagedEnvironmentPrivateEndpointConnectionsServer.Do(req)
	case "ManagedEnvironmentPrivateLinkResourcesClient":
		initServer(s, &s.trManagedEnvironmentPrivateLinkResourcesServer, func() *ManagedEnvironmentPrivateLinkResourcesServerTransport { return NewManagedEnvironmentPrivateLinkResourcesServerTransport(&s.srv.ManagedEnvironmentPrivateLinkResourcesServer) })
		resp, err = s.trManagedEnvironmentPrivateLinkResourcesServer.Do(req)
	case "ManagedEnvironmentUsagesClient":
		initServer(s, &s.trManagedEnvironmentUsagesServer, func() *ManagedEnvironmentUsagesServerTransport { return NewManagedEnvironmentUsagesServerTransport(&s.srv.ManagedEnvironmentUsagesServer) })
		resp, err = s.trManagedEnvironmentUsagesServer.Do(req)
	case "ManagedEnvironmentsClient":
		initServer(s, &s.trManagedEnvironmentsServer, func() *ManagedEnvironmentsServerTransport { return NewManagedEnvironmentsServerTransport(&s.srv.ManagedEnvironmentsServer) })
		resp, err = s.trManagedEnvironmentsServer.Do(req)
	case "ManagedEnvironmentsDiagnosticsClient":
		initServer(s, &s.trManagedEnvironmentsDiagnosticsServer, func() *ManagedEnvironmentsDiagnosticsServerTransport { return NewManagedEnvironmentsDiagnosticsServerTransport(&s.srv.ManagedEnvironmentsDiagnosticsServer) })
		resp, err = s.trManagedEnvironmentsDiagnosticsServer.Do(req)
	case "ManagedEnvironmentsStoragesClient":
		initServer(s, &s.trManagedEnvironmentsStoragesServer, func() *ManagedEnvironmentsStoragesServerTransport { return NewManagedEnvironmentsStoragesServerTransport(&s.srv.ManagedEnvironmentsStoragesServer) })
