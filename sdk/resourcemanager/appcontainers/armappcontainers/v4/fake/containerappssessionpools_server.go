...
type ContainerAppsSessionPoolsServer struct{
	...
	// FetchMcpServerCredentials is the fake for method ContainerAppsSessionPoolsClient.FetchMcpServerCredentials
	// HTTP status codes to indicate success: http.StatusOK
	FetchMcpServerCredentials func(ctx context.Context, resourceGroupName string, sessionPoolName string, options *armappcontainers.ContainerAppsSessionPoolsClientFetchMcpServerCredentialsOptions) (resp azfake.Responder[armappcontainers.ContainerAppsSessionPoolsClientFetchMcpServerCredentialsResponse], errResp azfake.ErrorResponder)
	...
	// RotateMcpServerCredentials is the fake for method ContainerAppsSessionPoolsClient.RotateMcpServerCredentials
	// HTTP status codes to indicate success: http.StatusOK
	RotateMcpServerCredentials func(ctx context.Context, resourceGroupName string, sessionPoolName string, options *armappcontainers.ContainerAppsSessionPoolsClientRotateMcpServerCredentialsOptions) (resp azfake.Responder[armappcontainers.ContainerAppsSessionPoolsClientRotateMcpServerCredentialsResponse], errResp azfake.ErrorResponder)
...
func (c *ContainerAppsSessionPoolsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "ContainerAppsSessionPoolsClient.FetchMcpServerCredentials":
				res.resp, res.err = c.dispatchFetchMcpServerCredentials(req)
			...
			case "ContainerAppsSessionPoolsClient.RotateMcpServerCredentials":
				res.resp, res.err = c.dispatchRotateMcpServerCredentials(req)
...
func (c *ContainerAppsSessionPoolsServerTransport) dispatchFetchMcpServerCredentials(req *http.Request) (*http.Response, error) {
	if c.srv.FetchMcpServerCredentials == nil {
		return nil, &nonRetriableError{errors.New("fake for method FetchMcpServerCredentials not implemented")}
	}
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.App/sessionPools/(?P<sessionPoolName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/fetchMcpServerCredentials`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 4 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	...
	respr, errRespr := c.srv.FetchMcpServerCredentials(req.Context(), resourceGroupNameParam, sessionPoolNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).McpServerCredential, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (c *ContainerAppsSessionPoolsServerTransport) dispatchRotateMcpServerCredentials(req *http.Request) (*http.Response, error) {
	if c.srv.RotateMcpServerCredentials == nil {
		return nil, &nonRetriableError{errors.New("fake for method RotateMcpServerCredentials not implemented")}
	}
	const regexStr = `/subscriptions/(?P<subscriptionId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/resourceGroups/(?P<resourceGroupName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.App/sessionPools/(?P<sessionPoolName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/rotateMcpServerCredentials`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if len(matches) < 4 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	...
	respr, errRespr := c.srv.RotateMcpServerCredentials(req.Context(), resourceGroupNameParam, sessionPoolNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
