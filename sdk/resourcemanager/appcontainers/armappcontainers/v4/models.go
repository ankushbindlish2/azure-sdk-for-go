...
type ContainerAppsFunction struct {
...
// ContainerAppsFunctionCollection - Container App Functions collection ARM resource.
type ContainerAppsFunctionCollection struct {
// REQUIRED; Collection of resources.
...
// ContainerAppsFunctionProperties - Function resource specific properties
type ContainerAppsFunctionProperties struct {
...
// READ-ONLY; Human readable message indicating details about the current condition of the job execution.
	Message *string

// READ-ONLY; Reason for the current condition of job execution.
	Reason *string
...
// The container type of the sessions. You can use your own container to build the session pool, or you can use a predefined
// container to run workload with specific language.
