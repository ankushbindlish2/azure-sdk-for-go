...
func (c *CertificateProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "isVerified":
			...
			delete(rawMsg, key)
		case "policyResourceId":
			err = unpopulate(val, "PolicyResourceID", &c.PolicyResourceID)
			delete(rawMsg, key)
		case "subject":
...
// MarshalJSON implements the json.Marshaller interface for type DeviceRegistry.
func (d DeviceRegistry) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "identityResourceId", d.IdentityResourceID)
	populate(objectMap, "namespaceResourceId", d.NamespaceResourceID)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type DeviceRegistry.
func (d *DeviceRegistry) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", d, err)
	}
	for key, val := range rawMsg {
		...
		case "identityResourceId":
			err = unpopulate(val, "IdentityResourceID", &d.IdentityResourceID)
			delete(rawMsg, key)
		case "namespaceResourceId":
			err = unpopulate(val, "NamespaceResourceID", &d.NamespaceResourceID)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", d, err)
...
func (e EndpointHealthData) MarshalJSON() ([]byte, error) {
	...
	populateTime[datetime.RFC1123](objectMap, "lastKnownErrorTime", e.LastKnownErrorTime)
	populateTime[datetime.RFC1123](objectMap, "lastSendAttemptTime", e.LastSendAttemptTime)
	populateTime[datetime.RFC1123](objectMap, "lastSuccessfulSendAttemptTime", e.LastSuccessfulSendAttemptTime)
	return json.Marshal(objectMap)
}
...
func (e *EndpointHealthData) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastKnownErrorTime":
			err = unpopulateTime[datetime.RFC1123](val, "LastKnownErrorTime", &e.LastKnownErrorTime)
			delete(rawMsg, key)
		case "lastSendAttemptTime":
			err = unpopulateTime[datetime.RFC1123](val, "LastSendAttemptTime", &e.LastSendAttemptTime)
			delete(rawMsg, key)
		case "lastSuccessfulSendAttemptTime":
			err = unpopulateTime[datetime.RFC1123](val, "LastSuccessfulSendAttemptTime", &e.LastSuccessfulSendAttemptTime)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
...
func (j JobResponse) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC1123](objectMap, "endTimeUtc", j.EndTimeUTC)
	...
	populateTime[datetime.RFC1123](objectMap, "startTimeUtc", j.StartTimeUTC)
...
func (j *JobResponse) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "endTimeUtc":
			err = unpopulateTime[datetime.RFC1123](val, "EndTimeUTC", &j.EndTimeUTC)
			delete(rawMsg, key)
		case "failureReason":
		...
		case "parentJobId":
			...
			delete(rawMsg, key)
		case "startTimeUtc":
			err = unpopulateTime[datetime.RFC1123](val, "StartTimeUTC", &j.StartTimeUTC)
			delete(rawMsg, key)
		case "status":
...
func (p Properties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "deviceRegistry", p.DeviceRegistry)
...
func (p *Properties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "comments":
			...
			delete(rawMsg, key)
		case "deviceRegistry":
			err = unpopulate(val, "DeviceRegistry", &p.DeviceRegistry)
			delete(rawMsg, key)
		case "deviceStreams":
...
func (r *RootCertificateProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastUpdatedTimeUtc":
			err = unpopulateTime[datetime.RFC3339](val, "LastUpdatedTimeUTC", &r.LastUpdatedTimeUTC)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", r, err)
