...
type DistributeVersionerLatest struct {
	// CONSTANT; Version numbering scheme to be used.
	// Field has constant value "Latest", any specified value is ignored.
	Scheme *string
...
type DistributeVersionerSource struct {
	// CONSTANT; Version numbering scheme to be used.
	// Field has constant value "Source", any specified value is ignored.
	Scheme *string
}
...
type ImageTemplateFileCustomizer struct {
	// CONSTANT; The type of customization tool you want to use on the Image. For example, "Shell" can be shell customizer
	// Field has constant value "File", any specified value is ignored.
	Type *string
...
type ImageTemplateFileValidator struct {
	// CONSTANT; The type of validation you want to use on the Image. For example, "Shell" can be shell validation
	// Field has constant value "File", any specified value is ignored.
	Type *string
...
// ImageTemplateListResult - The response of a ImageTemplate list operation.
type ImageTemplateListResult struct {
	// REQUIRED; The ImageTemplate items on this page
	Value []*ImageTemplate
...
type ImageTemplateManagedImageDistributor struct {
	...
	// CONSTANT; Type of distribution.
	// Field has constant value "ManagedImage", any specified value is ignored.
	Type *string
...
type ImageTemplateManagedImageSource struct {
	...
	// CONSTANT; Specifies the type of source image you want to start with.
	// Field has constant value "ManagedImage", any specified value is ignored.
	Type *string
}
...
type ImageTemplatePlatformImageSource struct {
	// CONSTANT; Specifies the type of source image you want to start with.
	// Field has constant value "PlatformImage", any specified value is ignored.
	Type *string
...
type ImageTemplatePowerShellCustomizer struct {
	// CONSTANT; The type of customization tool you want to use on the Image. For example, "Shell" can be shell customizer
	// Field has constant value "PowerShell", any specified value is ignored.
	Type *string
...
type ImageTemplateProperties struct {
	...
	// field is empty, a resource group with a random name will be created. If the resource group specified in this field doesn't
	// exist, it will be created with the same name. If the resource group specified exists, it must be empty and in the same
	// region as the image template. The resource group created will be deleted during template deletion if this field is empty
	// or the resource group specified doesn't exist, but if the resource group specified exists the resources created in the
	// resource group will be deleted during template deletion and the resource group itself will remain.
	...
	// image. This read-only field differs from 'stagingResourceGroup' only if the value specified in the 'stagingResourceGroup'
	// field is empty.
...
type ImageTemplatePropertiesErrorHandling struct {
	...
	// cleaned up. This is the default behavior. If there is a customizer error and this field is set to 'abort', the build VM
	// will be preserved.
	...
	// cleaned up. This is the default behavior. If there is a validation error and this field is set to 'abort', the build VM
	// will be preserved.
...
type ImageTemplateRestartCustomizer struct {
	// CONSTANT; The type of customization tool you want to use on the Image. For example, "Shell" can be shell customizer
	// Field has constant value "WindowsRestart", any specified value is ignored.
	Type *string
...
type ImageTemplateSharedImageDistributor struct {
	...
	// CONSTANT; Type of distribution.
	// Field has constant value "SharedImage", any specified value is ignored.
	Type *string
...
type ImageTemplateSharedImageVersionSource struct {
	...
	// CONSTANT; Specifies the type of source image you want to start with.
	// Field has constant value "SharedImageVersion", any specified value is ignored.
	Type *string
...
type ImageTemplateShellCustomizer struct {
	// CONSTANT; The type of customization tool you want to use on the Image. For example, "Shell" can be shell customizer
	// Field has constant value "Shell", any specified value is ignored.
	Type *string
...
type ImageTemplateVhdDistributor struct {
	...
	// CONSTANT; Type of distribution.
	// Field has constant value "VHD", any specified value is ignored.
	Type *string
...
type ImageTemplateWindowsUpdateCustomizer struct {
	// CONSTANT; The type of customization tool you want to use on the Image. For example, "Shell" can be shell customizer
	// Field has constant value "WindowsUpdate", any specified value is ignored.
	Type *string
...
type OperationListResult struct {
	// REQUIRED; The list of operations supported by the resource provider.
	Value []*Operation
...
type RunOutputCollection struct {
	// REQUIRED; The RunOutput items on this page
	Value []*RunOutput
...
type SourceImageTriggerProperties struct {
	// CONSTANT; The kind of trigger.
	// Field has constant value "SourceImage", any specified value is ignored.
	Kind *string
...
type TriggerCollection struct {
	// REQUIRED; The Trigger items on this page
	Value []*Trigger
...
type VirtualNetworkConfig struct {
	...
	// may be specified only if `subnetId` is also specified and must be on the same Virtual Network as the subnet specified in
	// `subnetId`.
