...
import (
	...
	"github.com/Azure/azure-sdk-for-go/sdk/resourcemanager/imagebuilder/armimagebuilder"
	"net/http"
	"net/url"
	"regexp"
	"slices"
...
// VirtualMachineImageTemplatesServer is a fake server for instances of the armimagebuilder.VirtualMachineImageTemplatesClient type.
type VirtualMachineImageTemplatesServer struct {
	...
	BeginCancel func(ctx context.Context, resourceGroupName string, imageTemplateName string, options *armimagebuilder.VirtualMachineImageTemplatesClientBeginCancelOptions) (resp azfake.PollerResponder[armimagebuilder.VirtualMachineImageTemplatesClientCancelResponse], errResp azfake.ErrorResponder)

	// BeginCreateOrUpdate is the fake for method VirtualMachineImageTemplatesClient.BeginCreateOrUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, imageTemplateName string, parameters armimagebuilder.ImageTemplate, options *armimagebuilder.VirtualMachineImageTemplatesClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armimagebuilder.VirtualMachineImageTemplatesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method VirtualMachineImageTemplatesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, imageTemplateName string, options *armimagebuilder.VirtualMachineImageTemplatesClientBeginDeleteOptions) (resp azfake.PollerResponder[armimagebuilder.VirtualMachineImageTemplatesClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method VirtualMachineImageTemplatesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, imageTemplateName string, options *armimagebuilder.VirtualMachineImageTemplatesClientGetOptions) (resp azfake.Responder[armimagebuilder.VirtualMachineImageTemplatesClientGetResponse], errResp azfake.ErrorResponder)

	// GetRunOutput is the fake for method VirtualMachineImageTemplatesClient.GetRunOutput
	// HTTP status codes to indicate success: http.StatusOK
	GetRunOutput func(ctx context.Context, resourceGroupName string, imageTemplateName string, runOutputName string, options *armimagebuilder.VirtualMachineImageTemplatesClientGetRunOutputOptions) (resp azfake.Responder[armimagebuilder.VirtualMachineImageTemplatesClientGetRunOutputResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method VirtualMachineImageTemplatesClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(options *armimagebuilder.VirtualMachineImageTemplatesClientListOptions) (resp azfake.PagerResponder[armimagebuilder.VirtualMachineImageTemplatesClientListResponse])

	// NewListByResourceGroupPager is the fake for method VirtualMachineImageTemplatesClient.NewListByResourceGroupPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByResourceGroupPager func(resourceGroupName string, options *armimagebuilder.VirtualMachineImageTemplatesClientListByResourceGroupOptions) (resp azfake.PagerResponder[armimagebuilder.VirtualMachineImageTemplatesClientListByResourceGroupResponse])

	// NewListRunOutputsPager is the fake for method VirtualMachineImageTemplatesClient.NewListRunOutputsPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListRunOutputsPager func(resourceGroupName string, imageTemplateName string, options *armimagebuilder.VirtualMachineImageTemplatesClientListRunOutputsOptions) (resp azfake.PagerResponder[armimagebuilder.VirtualMachineImageTemplatesClientListRunOutputsResponse])

	// BeginRun is the fake for method VirtualMachineImageTemplatesClient.BeginRun
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginRun func(ctx context.Context, resourceGroupName string, imageTemplateName string, options *armimagebuilder.VirtualMachineImageTemplatesClientBeginRunOptions) (resp azfake.PollerResponder[armimagebuilder.VirtualMachineImageTemplatesClientRunResponse], errResp azfake.ErrorResponder)

	// BeginUpdate is the fake for method VirtualMachineImageTemplatesClient.BeginUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted
	BeginUpdate func(ctx context.Context, resourceGroupName string, imageTemplateName string, parameters armimagebuilder.ImageTemplateUpdateParameters, options *armimagebuilder.VirtualMachineImageTemplatesClientBeginUpdateOptions) (resp azfake.PollerResponder[armimagebuilder.VirtualMachineImageTemplatesClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
// The returned VirtualMachineImageTemplatesServerTransport instance is connected to an instance of armimagebuilder.VirtualMachineImageTemplatesClient via the
...
func NewVirtualMachineImageTemplatesServerTransport(srv *VirtualMachineImageTemplatesServer) *VirtualMachineImageTemplatesServerTransport {
	return &VirtualMachineImageTemplatesServerTransport{
		srv:                         srv,
		beginCancel:                 newTracker[azfake.PollerResponder[armimagebuilder.VirtualMachineImageTemplatesClientCancelResponse]](),
		beginCreateOrUpdate:         newTracker[azfake.PollerResponder[armimagebuilder.VirtualMachineImageTemplatesClientCreateOrUpdateResponse]](),
		beginDelete:                 newTracker[azfake.PollerResponder[armimagebuilder.VirtualMachineImageTemplatesClientDeleteResponse]](),
		newListPager:                newTracker[azfake.PagerResponder[armimagebuilder.VirtualMachineImageTemplatesClientListResponse]](),
		newListByResourceGroupPager: newTracker[azfake.PagerResponder[armimagebuilder.VirtualMachineImageTemplatesClientListByResourceGroupResponse]](),
		newListRunOutputsPager:      newTracker[azfake.PagerResponder[armimagebuilder.VirtualMachineImageTemplatesClientListRunOutputsResponse]](),
		beginRun:                    newTracker[azfake.PollerResponder[armimagebuilder.VirtualMachineImageTemplatesClientRunResponse]](),
		beginUpdate:                 newTracker[azfake.PollerResponder[armimagebuilder.VirtualMachineImageTemplatesClientUpdateResponse]](),
	}
}

// VirtualMachineImageTemplatesServerTransport connects instances of armimagebuilder.VirtualMachineImageTemplatesClient to instances of VirtualMachineImageTemplatesServer.
...
type VirtualMachineImageTemplatesServerTransport struct {
	...
	beginCancel                 *tracker[azfake.PollerResponder[armimagebuilder.VirtualMachineImageTemplatesClientCancelResponse]]
	beginCreateOrUpdate         *tracker[azfake.PollerResponder[armimagebuilder.VirtualMachineImageTemplatesClientCreateOrUpdateResponse]]
	beginDelete                 *tracker[azfake.PollerResponder[armimagebuilder.VirtualMachineImageTemplatesClientDeleteResponse]]
	newListPager                *tracker[azfake.PagerResponder[armimagebuilder.VirtualMachineImageTemplatesClientListResponse]]
	newListByResourceGroupPager *tracker[azfake.PagerResponder[armimagebuilder.VirtualMachineImageTemplatesClientListByResourceGroupResponse]]
	newListRunOutputsPager      *tracker[azfake.PagerResponder[armimagebuilder.VirtualMachineImageTemplatesClientListRunOutputsResponse]]
	beginRun                    *tracker[azfake.PollerResponder[armimagebuilder.VirtualMachineImageTemplatesClientRunResponse]]
	beginUpdate                 *tracker[azfake.PollerResponder[armimagebuilder.VirtualMachineImageTemplatesClientUpdateResponse]]
}
...
func (v *VirtualMachineImageTemplatesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armimagebuilder.ImageTemplate](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
...
func (v *VirtualMachineImageTemplatesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *armimagebuilder.VirtualMachineImageTemplatesClientListResponse, createLink func() string) {
...
func (v *VirtualMachineImageTemplatesServerTransport) dispatchNewListByResourceGroupPager(req *http.Request) (*http.Response, error) {
	...
	if newListByResourceGroupPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByResourceGroupPager, req, func(page *armimagebuilder.VirtualMachineImageTemplatesClientListByResourceGroupResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (v *VirtualMachineImageTemplatesServerTransport) dispatchNewListRunOutputsPager(req *http.Request) (*http.Response, error) {
	...
	if newListRunOutputsPager == nil {
		...
		server.PagerResponderInjectNextLinks(newListRunOutputsPager, req, func(page *armimagebuilder.VirtualMachineImageTemplatesClientListRunOutputsResponse, createLink func() string) {
			page.NextLink = to.Ptr(createLink())
		})
	}
...
func (v *VirtualMachineImageTemplatesServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armimagebuilder.ImageTemplateUpdateParameters](req)
		if err != nil {
			return nil, err
		}
		resourceGroupNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("resourceGroupName")])
