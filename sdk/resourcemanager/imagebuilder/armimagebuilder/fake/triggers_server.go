...
// TriggersServer is a fake server for instances of the armimagebuilder.TriggersClient type.
type TriggersServer struct {
	// BeginCreateOrUpdate is the fake for method TriggersClient.BeginCreateOrUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	BeginCreateOrUpdate func(ctx context.Context, resourceGroupName string, imageTemplateName string, triggerName string, parameters armimagebuilder.Trigger, options *armimagebuilder.TriggersClientBeginCreateOrUpdateOptions) (resp azfake.PollerResponder[armimagebuilder.TriggersClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method TriggersClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceGroupName string, imageTemplateName string, triggerName string, options *armimagebuilder.TriggersClientBeginDeleteOptions) (resp azfake.PollerResponder[armimagebuilder.TriggersClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method TriggersClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceGroupName string, imageTemplateName string, triggerName string, options *armimagebuilder.TriggersClientGetOptions) (resp azfake.Responder[armimagebuilder.TriggersClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByImageTemplatePager is the fake for method TriggersClient.NewListByImageTemplatePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByImageTemplatePager func(resourceGroupName string, imageTemplateName string, options *armimagebuilder.TriggersClientListByImageTemplateOptions) (resp azfake.PagerResponder[armimagebuilder.TriggersClientListByImageTemplateResponse])
}

// NewTriggersServerTransport creates a new instance of TriggersServerTransport with the provided implementation.
// The returned TriggersServerTransport instance is connected to an instance of armimagebuilder.TriggersClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewTriggersServerTransport(srv *TriggersServer) *TriggersServerTransport {
	return &TriggersServerTransport{
		srv:                         srv,
		beginCreateOrUpdate:         newTracker[azfake.PollerResponder[armimagebuilder.TriggersClientCreateOrUpdateResponse]](),
		beginDelete:                 newTracker[azfake.PollerResponder[armimagebuilder.TriggersClientDeleteResponse]](),
		newListByImageTemplatePager: newTracker[azfake.PagerResponder[armimagebuilder.TriggersClientListByImageTemplateResponse]](),
	}
}

// TriggersServerTransport connects instances of armimagebuilder.TriggersClient to instances of TriggersServer.
// Don't use this type directly, use NewTriggersServerTransport instead.
type TriggersServerTransport struct {
	srv                         *TriggersServer
	beginCreateOrUpdate         *tracker[azfake.PollerResponder[armimagebuilder.TriggersClientCreateOrUpdateResponse]]
	beginDelete                 *tracker[azfake.PollerResponder[armimagebuilder.TriggersClientDeleteResponse]]
	newListByImageTemplatePager *tracker[azfake.PagerResponder[armimagebuilder.TriggersClientListByImageTemplateResponse]]
}
...
func (t *TriggersServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	if beginCreateOrUpdate == nil {
		...
		body, err := server.UnmarshalRequestAsJSON[armimagebuilder.Trigger](req)
		if err != nil {
			return nil, err
		}
...
func (t *TriggersServerTransport) dispatchNewListByImageTemplatePager(req *http.Request) (*http.Response, error) {
	...
	if newListByImageTemplatePager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByImageTemplatePager, req, func(page *armimagebuilder.TriggersClientListByImageTemplateResponse, createLink func() string) {
