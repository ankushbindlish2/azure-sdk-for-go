...
func ExampleOperationsClient_NewListPager() {
	...
	clientFactory, err := armimagebuilder.NewClientFactory("<subscriptionID>", cred, nil)
	if err != nil {
	...
	for pager.More() {
		...
		// page = armimagebuilder.OperationsClientListResponse{
		// 	OperationListResult: armimagebuilder.OperationListResult{
		// 		Value: []*armimagebuilder.Operation{
		// 			{
		// 				Name: to.Ptr("Microsoft.VirtualMachineImages/register/action"),
		// 				Display: &armimagebuilder.OperationDisplay{
