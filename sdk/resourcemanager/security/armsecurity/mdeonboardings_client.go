...
// NewListPager - The configuration or data needed to onboard the machine to MDE
//
// Generated from API version 2021-10-01-preview
//   - options - MdeOnboardingsClientListOptions contains the optional parameters for the MdeOnboardingsClient.NewListPager method.
func (client *MdeOnboardingsClient) NewListPager(options *MdeOnboardingsClientListOptions) *runtime.Pager[MdeOnboardingsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[MdeOnboardingsClientListResponse]{
		More: func(page MdeOnboardingsClientListResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *MdeOnboardingsClientListResponse) (MdeOnboardingsClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "MdeOnboardingsClient.NewListPager")
