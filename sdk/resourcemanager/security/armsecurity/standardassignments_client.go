...
//     method.
func (client *StandardAssignmentsClient) NewListPager(resourceID string, options *StandardAssignmentsClientListOptions) *runtime.Pager[StandardAssignmentsClientListResponse] {
...
func (client *StandardAssignmentsClient) listCreateRequest(ctx context.Context, resourceID string, _ *StandardAssignmentsClientListOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/standardAssignments"
	if resourceID == "" {
		return nil, errors.New("parameter resourceID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceId}", resourceID)
