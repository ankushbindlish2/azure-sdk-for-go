...
//     method.
func (client *InformationProtectionPoliciesClient) CreateOrUpdate(ctx context.Context, resourceID string, informationProtectionPolicyName InformationProtectionPolicyName, informationProtectionPolicy InformationProtectionPolicy, options *InformationProtectionPoliciesClientCreateOrUpdateOptions) (InformationProtectionPoliciesClientCreateOrUpdateResponse, error) {
	var err error
	const operationName = "InformationProtectionPoliciesClient.CreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, resourceID, informationProtectionPolicyName, informationProtectionPolicy, options)
	if err != nil {
...
func (client *InformationProtectionPoliciesClient) createOrUpdateCreateRequest(ctx context.Context, resourceID string, informationProtectionPolicyName InformationProtectionPolicyName, informationProtectionPolicy InformationProtectionPolicy, _ *InformationProtectionPoliciesClientCreateOrUpdateOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/informationProtectionPolicies/{informationProtectionPolicyName}"
	if resourceID == "" {
...
//     method.
func (client *InformationProtectionPoliciesClient) Get(ctx context.Context, resourceID string, informationProtectionPolicyName InformationProtectionPolicyName, options *InformationProtectionPoliciesClientGetOptions) (InformationProtectionPoliciesClientGetResponse, error) {
	var err error
	const operationName = "InformationProtectionPoliciesClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, resourceID, informationProtectionPolicyName, options)
	if err != nil {
...
func (client *InformationProtectionPoliciesClient) getCreateRequest(ctx context.Context, resourceID string, informationProtectionPolicyName InformationProtectionPolicyName, _ *InformationProtectionPoliciesClientGetOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/informationProtectionPolicies/{informationProtectionPolicyName}"
	if resourceID == "" {
		return nil, errors.New("parameter resourceID cannot be empty")
	}
...
//     method.
func (client *InformationProtectionPoliciesClient) NewListPager(resourceID string, options *InformationProtectionPoliciesClientListOptions) *runtime.Pager[InformationProtectionPoliciesClientListResponse] {
...
func (client *InformationProtectionPoliciesClient) listCreateRequest(ctx context.Context, resourceID string, _ *InformationProtectionPoliciesClientListOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/informationProtectionPolicies"
	if resourceID == "" {
		return nil, errors.New("parameter resourceID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceId}", resourceID)
