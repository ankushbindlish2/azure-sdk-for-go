...
func (client *JitNetworkAccessPoliciesClient) initiateCreateRequest(ctx context.Context, resourceGroupName string, ascLocation string, jitNetworkAccessPolicyName string, jitNetworkAccessPolicyInitiateType JitNetworkAccessPolicyInitiateType, body JitNetworkAccessPolicyInitiateRequest, _ *JitNetworkAccessPoliciesClientInitiateOptions) (*policy.Request, error) {
