...
//     method.
func (client *GovernanceRulesClient) CreateOrUpdate(ctx context.Context, resourceID string, ruleID string, governanceRule GovernanceRule, options *GovernanceRulesClientCreateOrUpdateOptions) (GovernanceRulesClientCreateOrUpdateResponse, error) {
	var err error
	const operationName = "GovernanceRulesClient.CreateOrUpdate"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.createOrUpdateCreateRequest(ctx, resourceID, ruleID, governanceRule, options)
	if err != nil {
...
func (client *GovernanceRulesClient) createOrUpdateCreateRequest(ctx context.Context, resourceID string, ruleID string, governanceRule GovernanceRule, _ *GovernanceRulesClientCreateOrUpdateOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/governanceRules/{ruleId}"
	if resourceID == "" {
...
//     method.
func (client *GovernanceRulesClient) BeginDelete(ctx context.Context, resourceID string, ruleID string, options *GovernanceRulesClientBeginDeleteOptions) (*runtime.Poller[GovernanceRulesClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteOperation(ctx, resourceID, ruleID, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2022-01-01-preview
func (client *GovernanceRulesClient) deleteOperation(ctx context.Context, resourceID string, ruleID string, options *GovernanceRulesClientBeginDeleteOptions) (*http.Response, error) {
	var err error
	const operationName = "GovernanceRulesClient.BeginDelete"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.deleteCreateRequest(ctx, resourceID, ruleID, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *GovernanceRulesClient) deleteCreateRequest(ctx context.Context, resourceID string, ruleID string, _ *GovernanceRulesClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/governanceRules/{ruleId}"
	if resourceID == "" {
		return nil, errors.New("parameter resourceID cannot be empty")
	}
...
//     method.
func (client *GovernanceRulesClient) BeginExecute(ctx context.Context, resourceID string, ruleID string, options *GovernanceRulesClientBeginExecuteOptions) (*runtime.Poller[GovernanceRulesClientExecuteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.execute(ctx, resourceID, ruleID, options)
		if err != nil {
			return nil, err
		}
...
//
// Generated from API version 2022-01-01-preview
func (client *GovernanceRulesClient) execute(ctx context.Context, resourceID string, ruleID string, options *GovernanceRulesClientBeginExecuteOptions) (*http.Response, error) {
	var err error
	const operationName = "GovernanceRulesClient.BeginExecute"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.executeCreateRequest(ctx, resourceID, ruleID, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *GovernanceRulesClient) executeCreateRequest(ctx context.Context, resourceID string, ruleID string, options *GovernanceRulesClientBeginExecuteOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/governanceRules/{ruleId}/execute"
	if resourceID == "" {
		return nil, errors.New("parameter resourceID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceId}", resourceID)
...
func (client *GovernanceRulesClient) Get(ctx context.Context, resourceID string, ruleID string, options *GovernanceRulesClientGetOptions) (GovernanceRulesClientGetResponse, error) {
	var err error
	const operationName = "GovernanceRulesClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, resourceID, ruleID, options)
	if err != nil {
...
func (client *GovernanceRulesClient) getCreateRequest(ctx context.Context, resourceID string, ruleID string, _ *GovernanceRulesClientGetOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/governanceRules/{ruleId}"
	if resourceID == "" {
		return nil, errors.New("parameter resourceID cannot be empty")
	}
...
//     method.
func (client *GovernanceRulesClient) NewListPager(resourceID string, options *GovernanceRulesClientListOptions) *runtime.Pager[GovernanceRulesClientListResponse] {
...
func (client *GovernanceRulesClient) listCreateRequest(ctx context.Context, resourceID string, _ *GovernanceRulesClientListOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/governanceRules"
	if resourceID == "" {
		return nil, errors.New("parameter resourceID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceId}", resourceID)
