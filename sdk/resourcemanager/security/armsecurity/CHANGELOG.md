...
- Function `*AlertsClient.NewListResourceGroupLevelByRegionPager` parameter(s) have been changed from `(ascLocation string, resourceGroupName string, options *AlertsClientListResourceGroupLevelByRegionOptions)` to `(resourceGroupName string, ascLocation string, options *AlertsClientListResourceGroupLevelByRegionOptions)`
- Function `*AssessmentsClient.NewListPager` parameter(s) have been changed from `(scope string, options *AssessmentsClientListOptions)` to `(resourceID string, options *AssessmentsClientListOptions)`
- Function `*ComplianceResultsClient.NewListPager` parameter(s) have been changed from `(scope string, options *ComplianceResultsClientListOptions)` to `(resourceID string, options *ComplianceResultsClientListOptions)`
- Function `*CompliancesClient.Get` parameter(s) have been changed from `(ctx context.Context, scope string, complianceName string, options *CompliancesClientGetOptions)` to `(ctx context.Context, resourceID string, complianceName string, options *CompliancesClientGetOptions)`
- Function `*CompliancesClient.NewListPager` parameter(s) have been changed from `(scope string, options *CompliancesClientListOptions)` to `(resourceID string, options *CompliancesClientListOptions)`
- Function `*GovernanceRulesClient.BeginDelete` parameter(s) have been changed from `(ctx context.Context, scope string, ruleID string, options *GovernanceRulesClientBeginDeleteOptions)` to `(ctx context.Context, resourceID string, ruleID string, options *GovernanceRulesClientBeginDeleteOptions)`
- Function `*GovernanceRulesClient.BeginExecute` parameter(s) have been changed from `(ctx context.Context, scope string, ruleID string, options *GovernanceRulesClientBeginExecuteOptions)` to `(ctx context.Context, resourceID string, ruleID string, options *GovernanceRulesClientBeginExecuteOptions)`
- Function `*GovernanceRulesClient.CreateOrUpdate` parameter(s) have been changed from `(ctx context.Context, scope string, ruleID string, governanceRule GovernanceRule, options *GovernanceRulesClientCreateOrUpdateOptions)` to `(ctx context.Context, resourceID string, ruleID string, governanceRule GovernanceRule, options *GovernanceRulesClientCreateOrUpdateOptions)`
- Function `*GovernanceRulesClient.Get` parameter(s) have been changed from `(ctx context.Context, scope string, ruleID string, options *GovernanceRulesClientGetOptions)` to `(ctx context.Context, resourceID string, ruleID string, options *GovernanceRulesClientGetOptions)`
- Function `*GovernanceRulesClient.NewListPager` parameter(s) have been changed from `(scope string, options *GovernanceRulesClientListOptions)` to `(resourceID string, options *GovernanceRulesClientListOptions)`
- Function `*HealthReportsClient.NewListPager` parameter(s) have been changed from `(scope string, options *HealthReportsClientListOptions)` to `(resourceID string, options *HealthReportsClientListOptions)`
- Function `*InformationProtectionPoliciesClient.CreateOrUpdate` parameter(s) have been changed from `(ctx context.Context, scope string, informationProtectionPolicyName InformationProtectionPolicyName, informationProtectionPolicy InformationProtectionPolicy, options *InformationProtectionPoliciesClientCreateOrUpdateOptions)` to `(ctx context.Context, resourceID string, informationProtectionPolicyName InformationProtectionPolicyName, informationProtectionPolicy InformationProtectionPolicy, options *InformationProtectionPoliciesClientCreateOrUpdateOptions)`
- Function `*InformationProtectionPoliciesClient.Get` parameter(s) have been changed from `(ctx context.Context, scope string, informationProtectionPolicyName InformationProtectionPolicyName, options *InformationProtectionPoliciesClientGetOptions)` to `(ctx context.Context, resourceID string, informationProtectionPolicyName InformationProtectionPolicyName, options *InformationProtectionPoliciesClientGetOptions)`
- Function `*InformationProtectionPoliciesClient.NewListPager` parameter(s) have been changed from `(scope string, options *InformationProtectionPoliciesClientListOptions)` to `(resourceID string, options *InformationProtectionPoliciesClientListOptions)`
- Function `*JitNetworkAccessPoliciesClient.Initiate` parameter(s) have been changed from `(ctx context.Context, resourceGroupName string, ascLocation string, jitNetworkAccessPolicyName string, body JitNetworkAccessPolicyInitiateRequest, options *JitNetworkAccessPoliciesClientInitiateOptions)` to `(ctx context.Context, resourceGroupName string, ascLocation string, jitNetworkAccessPolicyName string, jitNetworkAccessPolicyInitiateType JitNetworkAccessPolicyInitiateType, body JitNetworkAccessPolicyInitiateRequest, options *JitNetworkAccessPoliciesClientInitiateOptions)`
- Function `*PricingsClient.Delete` parameter(s) have been changed from `(ctx context.Context, scopeID string, pricingName string, options *PricingsClientDeleteOptions)` to `(ctx context.Context, resourceID string, pricingName string, options *PricingsClientDeleteOptions)`
- Function `*PricingsClient.Get` parameter(s) have been changed from `(ctx context.Context, scopeID string, pricingName string, options *PricingsClientGetOptions)` to `(ctx context.Context, resourceID string, pricingName string, options *PricingsClientGetOptions)`
- Function `*PricingsClient.Update` parameter(s) have been changed from `(ctx context.Context, scopeID string, pricingName string, pricing Pricing, options *PricingsClientUpdateOptions)` to `(ctx context.Context, resourceID string, pricingName string, pricing Pricing, options *PricingsClientUpdateOptions)`
...
- Function `*SQLVulnerabilityAssessmentScanResultsClient.Get` parameter(s) have been changed from `(ctx context.Context, scanID string, scanResultID string, workspaceID string, resourceID string, options *SQLVulnerabilityAssessmentScanResultsClientGetOptions)` to `(ctx context.Context, resourceID string, scanID string, scanResultID string, options *SQLVulnerabilityAssessmentScanResultsClientGetOptions)`
- Function `*SQLVulnerabilityAssessmentScansClient.Get` parameter(s) have been changed from `(ctx context.Context, scanID string, workspaceID string, resourceID string, options *SQLVulnerabilityAssessmentScansClientGetOptions)` to `(ctx context.Context, resourceID string, scanID string, options *SQLVulnerabilityAssessmentScansClientGetOptions)`
- Function `*ServerVulnerabilityAssessmentClient.BeginDelete` parameter(s) have been changed from `(ctx context.Context, resourceGroupName string, resourceNamespace string, resourceType string, resourceName string, options *ServerVulnerabilityAssessmentClientBeginDeleteOptions)` to `(ctx context.Context, resourceGroupName string, resourceNamespace string, resourceType string, resourceName string, serverVulnerabilityAssessment ServerVulnerabilityAssessmentName, options *ServerVulnerabilityAssessmentClientBeginDeleteOptions)`
- Function `*ServerVulnerabilityAssessmentClient.CreateOrUpdate` parameter(s) have been changed from `(ctx context.Context, resourceGroupName string, resourceNamespace string, resourceType string, resourceName string, options *ServerVulnerabilityAssessmentClientCreateOrUpdateOptions)` to `(ctx context.Context, resourceGroupName string, resourceNamespace string, resourceType string, resourceName string, serverVulnerabilityAssessment ServerVulnerabilityAssessmentName, options *ServerVulnerabilityAssessmentClientCreateOrUpdateOptions)`
- Function `*ServerVulnerabilityAssessmentClient.Get` parameter(s) have been changed from `(ctx context.Context, resourceGroupName string, resourceNamespace string, resourceType string, resourceName string, options *ServerVulnerabilityAssessmentClientGetOptions)` to `(ctx context.Context, resourceGroupName string, resourceNamespace string, resourceType string, resourceName string, serverVulnerabilityAssessment ServerVulnerabilityAssessmentName, options *ServerVulnerabilityAssessmentClientGetOptions)`
...
- Type of `DefenderCspmAwsOfferingCiem.CiemDiscovery` has been changed from `*DefenderCspmAwsOfferingCiemDiscovery` to `*DefenderCspmAwsOfferingCiemCiemDiscovery`
- Type of `DefenderCspmAwsOfferingCiem.CiemOidc` has been changed from `*DefenderCspmAwsOfferingCiemOidc` to `*DefenderCspmAwsOfferingCiemCiemOidc`
- Type of `DeviceSecurityGroupProperties.ThresholdRules` has been changed from `[]ThresholdCustomAlertRuleClassification` to `[]*ThresholdCustomAlertRule`
...
- Type of `ServerVulnerabilityProperties.AssessedResourceType` has been changed from `*AssessedResourceType` to `*string`
...
- `RecommendationTypeIoTAcrauthentication`, `RecommendationTypeIoTIpfilterDenyAll`, `RecommendationTypeIoTIpfilterPermissiveRule` from enum `RecommendationType` has been removed
...
- Operation `*MdeOnboardingsClient.List` has supported pagination, use `*MdeOnboardingsClient.NewListPager` instead.
- Operation `*OperatorsClient.List` has supported pagination, use `*OperatorsClient.NewListPager` instead.
- Operation `*PricingsClient.List` has supported pagination, use `*PricingsClient.NewListPager` instead.
...
- Operation `*SensitivitySettingsClient.List` has supported pagination, use `*SensitivitySettingsClient.NewListPager` instead.
- Operation `*ServerVulnerabilityAssessmentClient.ListByExtendedResource` has supported pagination, use `*ServerVulnerabilityAssessmentClient.NewListByExtendedResourcePager` instead.
...
- Field `PrincipalID`, `TenantID` of struct `Identity` has been removed
...
- New value `RecommendationTypeIoTACRAuthentication`, `RecommendationTypeIoTIPFilterDenyAll`, `RecommendationTypeIoTIPFilterPermissiveRule` added to enum type `RecommendationType`
...
- New enum type `JitNetworkAccessPolicyInitiateType` with values `JitNetworkAccessPolicyInitiateTypeInitiate`
...
- New enum type `ResourceIdentityType` with values `ResourceIdentityTypeSystemAssigned`
...
- New enum type `ServerVulnerabilityAssessmentName` with values `ServerVulnerabilityAssessmentNameDefault`
...
- New function `*CustomRecommendationsClient.CreateOrUpdate(ctx context.Context, resourceID string, customRecommendationName string, customRecommendationBody CustomRecommendation, options *CustomRecommendationsClientCreateOrUpdateOptions) (CustomRecommendationsClientCreateOrUpdateResponse, error)`
- New function `*CustomRecommendationsClient.Delete(ctx context.Context, resourceID string, customRecommendationName string, options *CustomRecommendationsClientDeleteOptions) (CustomRecommendationsClientDeleteResponse, error)`
- New function `*CustomRecommendationsClient.Get(ctx context.Context, resourceID string, customRecommendationName string, options *CustomRecommendationsClientGetOptions) (CustomRecommendationsClientGetResponse, error)`
- New function `*CustomRecommendationsClient.NewListPager(resourceID string, options *CustomRecommendationsClientListOptions) *runtime.Pager[CustomRecommendationsClientListResponse]`
...
- New function `*PrivateEndpointConnectionsClient.BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, privateEndpointConnectionName string, properties PrivateEndpointConnectionProperties, params PrivateLinkParameters, options *PrivateEndpointConnectionsClientBeginCreateOrUpdateOptions) (*runtime.Poller[PrivateEndpointConnectionsClientCreateOrUpdateResponse], error)`
- New function `*PrivateEndpointConnectionsClient.BeginDelete(ctx context.Context, resourceGroupName string, privateEndpointConnectionName string, params PrivateLinkParameters, options *PrivateEndpointConnectionsClientBeginDeleteOptions) (*runtime.Poller[PrivateEndpointConnectionsClientDeleteResponse], error)`
- New function `*PrivateEndpointConnectionsClient.Get(ctx context.Context, resourceGroupName string, privateEndpointConnectionName string, params PrivateLinkParameters, options *PrivateEndpointConnectionsClientGetOptions) (PrivateEndpointConnectionsClientGetResponse, error)`
- New function `*PrivateEndpointConnectionsClient.NewListPager(resourceGroupName string, params PrivateLinkParameters, options *PrivateEndpointConnectionsClientListOptions) *runtime.Pager[PrivateEndpointConnectionsClientListResponse]`
...
- New function `*PrivateLinkResourcesClient.Get(ctx context.Context, resourceGroupName string, groupID string, params PrivateLinkParameters, options *PrivateLinkResourcesClientGetOptions) (PrivateLinkResourcesClientGetResponse, error)`
- New function `*PrivateLinkResourcesClient.NewListPager(resourceGroupName string, params PrivateLinkParameters, options *PrivateLinkResourcesClientListOptions) *runtime.Pager[PrivateLinkResourcesClientListResponse]`
...
- New function `*PrivateLinksClient.BeginCreate(ctx context.Context, resourceGroupName string, privateLink PrivateLinkResource, params PrivateLinkParameters, options *PrivateLinksClientBeginCreateOptions) (*runtime.Poller[PrivateLinksClientCreateResponse], error)`
- New function `*PrivateLinksClient.BeginDelete(ctx context.Context, resourceGroupName string, params PrivateLinkParameters, options *PrivateLinksClientBeginDeleteOptions) (*runtime.Poller[PrivateLinksClientDeleteResponse], error)`
- New function `*PrivateLinksClient.Get(ctx context.Context, resourceGroupName string, params PrivateLinkParameters, options *PrivateLinksClientGetOptions) (PrivateLinksClientGetResponse, error)`
- New function `*PrivateLinksClient.Head(ctx context.Context, resourceGroupName string, params PrivateLinkParameters, options *PrivateLinksClientHeadOptions) (PrivateLinksClientHeadResponse, error)`
...
- New function `*PrivateLinksClient.Update(ctx context.Context, resourceGroupName string, privateLink PrivateLinkUpdate, params PrivateLinkParameters, options *PrivateLinksClientUpdateOptions) (PrivateLinksClientUpdateResponse, error)`
...
- New function `*StandardAssignmentsClient.NewListPager(resourceID string, options *StandardAssignmentsClientListOptions) *runtime.Pager[StandardAssignmentsClientListResponse]`
...
- New struct `DefenderCspmAwsOfferingCiemCiemDiscovery`
- New struct `DefenderCspmAwsOfferingCiemCiemOidc`
...
- New struct `ExternalSecuritySolutionProperties1`
