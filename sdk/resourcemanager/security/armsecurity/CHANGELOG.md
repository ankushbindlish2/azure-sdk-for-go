...
- Function `*DefenderForStorageClient.Create` parameter(s) have been changed from `(ctx context.Context, resourceID string, settingName SettingName, defenderForStorageSetting DefenderForStorageSetting, options *DefenderForStorageClientCreateOptions)` to `(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, defenderForStorageSetting DefenderForStorageSetting, options *DefenderForStorageClientCreateOptions)`
- Function `*DefenderForStorageClient.Get` parameter(s) have been changed from `(ctx context.Context, resourceID string, settingName SettingName, options *DefenderForStorageClientGetOptions)` to `(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, options *DefenderForStorageClientGetOptions)`
...
- New function `NewArmStandardsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*ArmStandardsClient, error)`
- New function `*ArmStandardsClient.CreateOrUpdate(ctx context.Context, resourceGroupName string, standardID string, standard Standard, options *ArmStandardsClientCreateOrUpdateOptions) (ArmStandardsClientCreateOrUpdateResponse, error)`
- New function `*ArmStandardsClient.Delete(ctx context.Context, resourceGroupName string, standardID string, options *ArmStandardsClientDeleteOptions) (ArmStandardsClientDeleteResponse, error)`
- New function `*ArmStandardsClient.Get(ctx context.Context, resourceGroupName string, standardID string, options *ArmStandardsClientGetOptions) (ArmStandardsClientGetResponse, error)`
- New function `*ArmStandardsClient.NewListBySubscriptionPager(options *ArmStandardsClientListBySubscriptionOptions) *runtime.Pager[ArmStandardsClientListBySubscriptionResponse]`
- New function `*ArmStandardsClient.NewListPager(resourceGroupName string, options *ArmStandardsClientListOptions) *runtime.Pager[ArmStandardsClientListResponse]`
...
- New function `*ClientFactory.NewArmStandardsClient() *ArmStandardsClient`
...
- New function `*DefenderForStorageClient.CancelMalwareScan(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, scanID string, options *DefenderForStorageClientCancelMalwareScanOptions) (DefenderForStorageClientCancelMalwareScanResponse, error)`
- New function `*DefenderForStorageClient.GetMalwareScan(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, scanID string, options *DefenderForStorageClientGetMalwareScanOptions) (DefenderForStorageClientGetMalwareScanResponse, error)`
...
- New function `*DefenderForStorageClient.StartMalwareScan(ctx context.Context, resourceID string, settingName SettingNameAutoGenerated, options *DefenderForStorageClientStartMalwareScanOptions) (DefenderForStorageClientStartMalwareScanResponse, error)`
...
- New function `*PrivateEndpointConnectionsClient.BeginCreateOrUpdate(ctx context.Context, resourceGroupName string, privateEndpointConnectionName string, privateEndpointConnection PrivateEndpointConnection, privateLinkParameters PrivateLinkParameters, options *PrivateEndpointConnectionsClientBeginCreateOrUpdateOptions) (*runtime.Poller[PrivateEndpointConnectionsClientCreateOrUpdateResponse], error)`
- New function `*PrivateEndpointConnectionsClient.BeginDelete(ctx context.Context, resourceGroupName string, privateEndpointConnectionName string, privateLinkParameters PrivateLinkParameters, options *PrivateEndpointConnectionsClientBeginDeleteOptions) (*runtime.Poller[PrivateEndpointConnectionsClientDeleteResponse], error)`
- New function `*PrivateEndpointConnectionsClient.Get(ctx context.Context, resourceGroupName string, privateEndpointConnectionName string, privateLinkParameters PrivateLinkParameters, options *PrivateEndpointConnectionsClientGetOptions) (PrivateEndpointConnectionsClientGetResponse, error)`
- New function `*PrivateEndpointConnectionsClient.NewListPager(resourceGroupName string, privateLinkParameters PrivateLinkParameters, options *PrivateEndpointConnectionsClientListOptions) *runtime.Pager[PrivateEndpointConnectionsClientListResponse]`
...
- New function `*PrivateLinkResourcesClient.Get(ctx context.Context, resourceGroupName string, groupID string, privateLinkParameters PrivateLinkParameters, options *PrivateLinkResourcesClientGetOptions) (PrivateLinkResourcesClientGetResponse, error)`
- New function `*PrivateLinkResourcesClient.NewListPager(resourceGroupName string, privateLinkParameters PrivateLinkParameters, options *PrivateLinkResourcesClientListOptions) *runtime.Pager[PrivateLinkResourcesClientListResponse]`
...
- New function `*PrivateLinksClient.BeginCreate(ctx context.Context, resourceGroupName string, privateLink PrivateLinkResource, privateLinkParameters PrivateLinkParameters, options *PrivateLinksClientBeginCreateOptions) (*runtime.Poller[PrivateLinksClientCreateResponse], error)`
- New function `*PrivateLinksClient.BeginDelete(ctx context.Context, resourceGroupName string, privateLinkParameters PrivateLinkParameters, options *PrivateLinksClientBeginDeleteOptions) (*runtime.Poller[PrivateLinksClientDeleteResponse], error)`
- New function `*PrivateLinksClient.Get(ctx context.Context, resourceGroupName string, privateLinkParameters PrivateLinkParameters, options *PrivateLinksClientGetOptions) (PrivateLinksClientGetResponse, error)`
- New function `*PrivateLinksClient.Head(ctx context.Context, resourceGroupName string, privateLinkParameters PrivateLinkParameters, options *PrivateLinksClientHeadOptions) (PrivateLinksClientHeadResponse, error)`
...
- New function `*PrivateLinksClient.Update(ctx context.Context, resourceGroupName string, privateLink PrivateLinkUpdate, privateLinkParameters PrivateLinkParameters, options *PrivateLinksClientUpdateOptions) (PrivateLinksClientUpdateResponse, error)`
...
- New function `*SQLVulnerabilityAssessmentSettingsClient.CreateOrUpdate(ctx context.Context, resourceID string, options *SQLVulnerabilityAssessmentSettingsClientCreateOrUpdateOptions) (SQLVulnerabilityAssessmentSettingsClientCreateOrUpdateResponse, error)`
...
- New struct `AssessmentPropertiesBaseRiskPathsPropertiesItemsItem`
- New struct `AssignedAssessmentItem`
- New struct `AssignedComponentItem`
- New struct `AssignedStandardItem`
- New struct `AssignedStandardItemAutoGenerated`
...
- New struct `Components1Uu4J47SchemasSecurityassessmentpropertiesbasePropertiesRiskPropertiesPathsItemsPropertiesEdgesItems`
...
- New struct `PrivateLinkResourceAutoGenerated`
...
- New struct `StandardPropertiesAutoGenerated`
