...
// DefenderCspmAwsOfferingCiemCiemDiscovery - Defender CSPM Permissions Management discovery configuration
type DefenderCspmAwsOfferingCiemCiemDiscovery struct {
	// The cloud role ARN in AWS for Permissions Management discovery
	CloudRoleArn *string
}

// DefenderCspmAwsOfferingCiemCiemOidc - AWS Defender CSPM Permissions Management OIDC (open id connect) connection configurations
...
type ExternalSecuritySolution struct {
	...
	Properties *ExternalSecuritySolutionProperties1
...
type ExternalSecuritySolutionProperties1 struct {
}
