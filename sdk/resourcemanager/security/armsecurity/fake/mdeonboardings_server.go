...
type MdeOnboardingsServer struct {
	...
	// NewListPager is the fake for method MdeOnboardingsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(options *armsecurity.MdeOnboardingsClientListOptions) (resp azfake.PagerResponder[armsecurity.MdeOnboardingsClientListResponse])
}
...
func NewMdeOnboardingsServerTransport(srv *MdeOnboardingsServer) *MdeOnboardingsServerTransport {
	return &MdeOnboardingsServerTransport{
		srv:          srv,
		newListPager: newTracker[azfake.PagerResponder[armsecurity.MdeOnboardingsClientListResponse]](),
	}
}
...
type MdeOnboardingsServerTransport struct {
	...
	newListPager *tracker[azfake.PagerResponder[armsecurity.MdeOnboardingsClientListResponse]]
}
...
func (m *MdeOnboardingsServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			...
			case "MdeOnboardingsClient.NewListPager":
...
func (m *MdeOnboardingsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
