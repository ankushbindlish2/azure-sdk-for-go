...
type GovernanceRulesServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceID string, ruleID string, governanceRule armsecurity.GovernanceRule, options *armsecurity.GovernanceRulesClientCreateOrUpdateOptions) (resp azfake.Responder[armsecurity.GovernanceRulesClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// BeginDelete is the fake for method GovernanceRulesClient.BeginDelete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginDelete func(ctx context.Context, resourceID string, ruleID string, options *armsecurity.GovernanceRulesClientBeginDeleteOptions) (resp azfake.PollerResponder[armsecurity.GovernanceRulesClientDeleteResponse], errResp azfake.ErrorResponder)

	// BeginExecute is the fake for method GovernanceRulesClient.BeginExecute
	// HTTP status codes to indicate success: http.StatusOK, http.StatusAccepted, http.StatusNoContent
	BeginExecute func(ctx context.Context, resourceID string, ruleID string, options *armsecurity.GovernanceRulesClientBeginExecuteOptions) (resp azfake.PollerResponder[armsecurity.GovernanceRulesClientExecuteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method GovernanceRulesClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceID string, ruleID string, options *armsecurity.GovernanceRulesClientGetOptions) (resp azfake.Responder[armsecurity.GovernanceRulesClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method GovernanceRulesClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceID string, options *armsecurity.GovernanceRulesClientListOptions) (resp azfake.PagerResponder[armsecurity.GovernanceRulesClientListResponse])
...
func (g *GovernanceRulesServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/(?P<resourceId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Security/governanceRules/(?P<ruleId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
	...
	respr, errRespr := g.srv.CreateOrUpdate(req.Context(), resourceIDParam, ruleIDParam, body, nil)
...
func (g *GovernanceRulesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
	...
	if beginDelete == nil {
		...
		respr, errRespr := g.srv.BeginDelete(req.Context(), resourceIDParam, ruleIDParam, nil)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginDelete = &respr
...
func (g *GovernanceRulesServerTransport) dispatchBeginExecute(req *http.Request) (*http.Response, error) {
	...
	if beginExecute == nil {
		const regexStr = `/(?P<resourceId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Security/governanceRules/(?P<ruleId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/execute`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 3 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		respr, errRespr := g.srv.BeginExecute(req.Context(), resourceIDParam, ruleIDParam, options)
		if respErr := server.GetError(errRespr, req); respErr != nil {
			return nil, respErr
		}
		beginExecute = &respr
...
func (g *GovernanceRulesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := g.srv.Get(req.Context(), resourceIDParam, ruleIDParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (g *GovernanceRulesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		const regexStr = `/(?P<resourceId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Security/governanceRules`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 2 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		resp := g.srv.NewListPager(resourceIDParam, nil)
		newListPager = &resp
