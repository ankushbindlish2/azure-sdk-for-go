...
type CustomRecommendationsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, resourceID string, customRecommendationName string, customRecommendationBody armsecurity.CustomRecommendation, options *armsecurity.CustomRecommendationsClientCreateOrUpdateOptions) (resp azfake.Responder[armsecurity.CustomRecommendationsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method CustomRecommendationsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, resourceID string, customRecommendationName string, options *armsecurity.CustomRecommendationsClientDeleteOptions) (resp azfake.Responder[armsecurity.CustomRecommendationsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method CustomRecommendationsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, resourceID string, customRecommendationName string, options *armsecurity.CustomRecommendationsClientGetOptions) (resp azfake.Responder[armsecurity.CustomRecommendationsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListPager is the fake for method CustomRecommendationsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(resourceID string, options *armsecurity.CustomRecommendationsClientListOptions) (resp azfake.PagerResponder[armsecurity.CustomRecommendationsClientListResponse])
}
...
func (c *CustomRecommendationsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/(?P<resourceId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Security/customRecommendations/(?P<customRecommendationName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
	...
	respr, errRespr := c.srv.CreateOrUpdate(req.Context(), resourceIDParam, customRecommendationNameParam, body, nil)
...
func (c *CustomRecommendationsServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := c.srv.Delete(req.Context(), resourceIDParam, customRecommendationNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (c *CustomRecommendationsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := c.srv.Get(req.Context(), resourceIDParam, customRecommendationNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (c *CustomRecommendationsServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
	...
	if newListPager == nil {
		const regexStr = `/(?P<resourceId>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Microsoft\.Security/customRecommendations`
		regex := regexp.MustCompile(regexStr)
		matches := regex.FindStringSubmatch(req.URL.EscapedPath())
		if len(matches) < 2 {
			return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
		...
		resp := c.srv.NewListPager(resourceIDParam, nil)
		newListPager = &resp
