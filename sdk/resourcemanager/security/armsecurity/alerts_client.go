...
//     method.
func (client *AlertsClient) NewListResourceGroupLevelByRegionPager(resourceGroupName string, ascLocation string, options *AlertsClientListResourceGroupLevelByRegionOptions) *runtime.Pager[AlertsClientListResourceGroupLevelByRegionResponse] {
	return runtime.NewPager(runtime.PagingHandler[AlertsClientListResourceGroupLevelByRegionResponse]{
		...
		Fetcher: func(ctx context.Context, page *AlertsClientListResourceGroupLevelByRegionResponse) (AlertsClientListResourceGroupLevelByRegionResponse, error) {
			...
			resp, err := runtime.FetcherForNextLink(ctx, client.internal.Pipeline(), nextLink, func(ctx context.Context) (*policy.Request, error) {
				return client.listResourceGroupLevelByRegionCreateRequest(ctx, resourceGroupName, ascLocation, options)
			}, nil)
			if err != nil {
...
func (client *AlertsClient) listResourceGroupLevelByRegionCreateRequest(ctx context.Context, resourceGroupName string, ascLocation string, _ *AlertsClientListResourceGroupLevelByRegionOptions) (*policy.Request, error) {
...
// Generated from API version 2022-01-01
//   - ascLocation - The location where ASC stores the data of the subscription. can be retrieved from Get locations
//   - alertSimulatorRequestBody - The request body
