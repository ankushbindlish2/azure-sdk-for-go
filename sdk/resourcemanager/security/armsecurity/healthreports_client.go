...
func (client *HealthReportsClient) NewListPager(resourceID string, options *HealthReportsClientListOptions) *runtime.Pager[HealthReportsClientListResponse] {
...
func (client *HealthReportsClient) listCreateRequest(ctx context.Context, resourceID string, _ *HealthReportsClientListOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/healthReports"
	if resourceID == "" {
		return nil, errors.New("parameter resourceID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceId}", resourceID)
