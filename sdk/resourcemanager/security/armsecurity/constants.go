...
type JitNetworkAccessPolicyInitiateType string

const (
	JitNetworkAccessPolicyInitiateTypeInitiate JitNetworkAccessPolicyInitiateType = "initiate"
)

// PossibleJitNetworkAccessPolicyInitiateTypeValues returns the possible values for the JitNetworkAccessPolicyInitiateType const type.
func PossibleJitNetworkAccessPolicyInitiateTypeValues() []JitNetworkAccessPolicyInitiateType {
	return []JitNetworkAccessPolicyInitiateType{
		JitNetworkAccessPolicyInitiateTypeInitiate,
	}
}
...
type ServerVulnerabilityAssessmentName string

const (
	ServerVulnerabilityAssessmentNameDefault ServerVulnerabilityAssessmentName = "default"
)

// PossibleServerVulnerabilityAssessmentNameValues returns the possible values for the ServerVulnerabilityAssessmentName const type.
func PossibleServerVulnerabilityAssessmentNameValues() []ServerVulnerabilityAssessmentName {
	return []ServerVulnerabilityAssessmentName{
		ServerVulnerabilityAssessmentNameDefault,
	}
}
