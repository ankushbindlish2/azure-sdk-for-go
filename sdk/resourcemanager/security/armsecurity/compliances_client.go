...
func (client *CompliancesClient) Get(ctx context.Context, resourceID string, complianceName string, options *CompliancesClientGetOptions) (CompliancesClientGetResponse, error) {
	var err error
	const operationName = "CompliancesClient.Get"
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, operationName)
	ctx, endSpan := runtime.StartSpan(ctx, operationName, client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
	req, err := client.getCreateRequest(ctx, resourceID, complianceName, options)
	if err != nil {
...
func (client *CompliancesClient) getCreateRequest(ctx context.Context, resourceID string, complianceName string, _ *CompliancesClientGetOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/compliances/{complianceName}"
	if resourceID == "" {
...
func (client *CompliancesClient) NewListPager(resourceID string, options *CompliancesClientListOptions) *runtime.Pager[CompliancesClientListResponse] {
...
func (client *CompliancesClient) listCreateRequest(ctx context.Context, resourceID string, _ *CompliancesClientListOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/compliances"
	if resourceID == "" {
		return nil, errors.New("parameter resourceID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceId}", resourceID)
