...
// NewListPager - Gets a list with a single sensitivity settings resource
//
// Generated from API version 2023-02-15-preview
//   - options - SensitivitySettingsClientListOptions contains the optional parameters for the SensitivitySettingsClient.NewListPager
//     method.
func (client *SensitivitySettingsClient) NewListPager(options *SensitivitySettingsClientListOptions) *runtime.Pager[SensitivitySettingsClientListResponse] {
	return runtime.NewPager(runtime.PagingHandler[SensitivitySettingsClientListResponse]{
		More: func(page SensitivitySettingsClientListResponse) bool {
			return false
		},
		Fetcher: func(ctx context.Context, page *SensitivitySettingsClientListResponse) (SensitivitySettingsClientListResponse, error) {
			ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "SensitivitySettingsClient.NewListPager")
