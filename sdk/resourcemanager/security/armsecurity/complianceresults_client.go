...
//     method.
func (client *ComplianceResultsClient) NewListPager(resourceID string, options *ComplianceResultsClientListOptions) *runtime.Pager[ComplianceResultsClientListResponse] {
...
func (client *ComplianceResultsClient) listCreateRequest(ctx context.Context, resourceID string, _ *ComplianceResultsClientListOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/complianceResults"
	if resourceID == "" {
		return nil, errors.New("parameter resourceID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceId}", resourceID)
