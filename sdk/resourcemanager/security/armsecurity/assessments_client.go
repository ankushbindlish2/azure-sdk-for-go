...
func (client *AssessmentsClient) NewListPager(resourceID string, options *AssessmentsClientListOptions) *runtime.Pager[AssessmentsClientListResponse] {
...
func (client *AssessmentsClient) listCreateRequest(ctx context.Context, resourceID string, _ *AssessmentsClientListOptions) (*policy.Request, error) {
	urlPath := "/{resourceId}/providers/Microsoft.Security/assessments"
	if resourceID == "" {
		return nil, errors.New("parameter resourceID cannot be empty")
	}
	urlPath = strings.ReplaceAll(urlPath, "{resourceId}", resourceID)
