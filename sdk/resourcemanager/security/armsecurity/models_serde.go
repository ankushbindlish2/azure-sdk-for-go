...
func (e ExternalSecuritySolution) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "name", e.Name)
	populateAny(objectMap, "properties", e.Properties)
...
func (o OnPremiseResourceDetails) MarshalJSON() ([]byte, error) {
	...
	objectMap["source"] = SourceOnPremiseResourceDetails
...
func (s ServerVulnerabilityProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	objectMap["assessedResourceType"] = AssessedResourceTypeServerVulnerabilityAssessment
