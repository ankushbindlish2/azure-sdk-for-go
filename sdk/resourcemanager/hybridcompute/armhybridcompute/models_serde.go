...
func (a *AgentUpgrade) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastAttemptTimestamp":
			err = unpopulateTime[datetime.RFC3339](val, "LastAttemptTimestamp", &a.LastAttemptTimestamp)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", a, err)
...
func (e *ExtensionsResourceStatus) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "message":
			...
			delete(rawMsg, key)
		case "time":
			err = unpopulateTime[datetime.RFC3339](val, "Time", &e.Time)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
...
func (k KeyDetails) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populateTime[datetime.RFC3339](objectMap, "notAfter", k.NotAfter)
	populate(objectMap, "publicKey", k.PublicKey)
	populateTime[datetime.RFC3339](objectMap, "renewAfter", k.RenewAfter)
	return json.Marshal(objectMap)
}
...
func (k *KeyDetails) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "notAfter":
			err = unpopulateTime[datetime.RFC3339](val, "NotAfter", &k.NotAfter)
			delete(rawMsg, key)
		case "publicKey":
			err = unpopulate(val, "PublicKey", &k.PublicKey)
			delete(rawMsg, key)
		case "renewAfter":
			err = unpopulateTime[datetime.RFC3339](val, "RenewAfter", &k.RenewAfter)
			delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", k, err)
...
func (l *LicenseProfileArmProductProfileProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "billingEndDate":
			err = unpopulateTime[datetime.RFC3339](val, "BillingEndDate", &l.BillingEndDate)
			delete(rawMsg, key)
		case "billingStartDate":
			err = unpopulateTime[datetime.RFC3339](val, "BillingStartDate", &l.BillingStartDate)
			delete(rawMsg, key)
		case "disenrollmentDate":
			err = unpopulateTime[datetime.RFC3339](val, "DisenrollmentDate", &l.DisenrollmentDate)
			delete(rawMsg, key)
		case "enrollmentDate":
			err = unpopulateTime[datetime.RFC3339](val, "EnrollmentDate", &l.EnrollmentDate)
			delete(rawMsg, key)
		case "error":
...
func (m *MachineAssessPatchesResult) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastModifiedDateTime":
			err = unpopulateTime[datetime.RFC3339](val, "LastModifiedDateTime", &m.LastModifiedDateTime)
			delete(rawMsg, key)
		case "osType":
		...
		case "rebootPending":
			...
			delete(rawMsg, key)
		case "startDateTime":
			err = unpopulateTime[datetime.RFC3339](val, "StartDateTime", &m.StartDateTime)
			delete(rawMsg, key)
		case "startedBy":
...
func (m *MachineProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "lastStatusChange":
			err = unpopulateTime[datetime.RFC3339](val, "LastStatusChange", &m.LastStatusChange)
			delete(rawMsg, key)
		case "licenseProfile":
...
func (p *ProductFeature) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		switch key {
		case "billingEndDate":
			err = unpopulateTime[datetime.RFC3339](val, "BillingEndDate", &p.BillingEndDate)
			delete(rawMsg, key)
		case "billingStartDate":
			err = unpopulateTime[datetime.RFC3339](val, "BillingStartDate", &p.BillingStartDate)
			delete(rawMsg, key)
		case "disenrollmentDate":
			err = unpopulateTime[datetime.RFC3339](val, "DisenrollmentDate", &p.DisenrollmentDate)
			delete(rawMsg, key)
		case "enrollmentDate":
			err = unpopulateTime[datetime.RFC3339](val, "EnrollmentDate", &p.EnrollmentDate)
			delete(rawMsg, key)
		case "error":
			err = unpopulate(val, "Error", &p.Error)
			delete(rawMsg, key)
