...
func (s *ServerFactoryTransport) Do(req *http.Request) (*http.Response, error) {
	...
	case "AgentVersionClient":
		initServer(&s.trMu, &s.trAgentVersionServer, func() *AgentVersionServerTransport { return NewAgentVersionServerTransport(&s.srv.AgentVersionServer) })
	...
	case "NetworkConfigurationsClient":
		initServer(&s.trMu, &s.trNetworkConfigurationsServer, func() *NetworkConfigurationsServerTransport {
