...
- New function `*ManagementClient.NewAgentVersionClient() *AgentVersionClient`
- New function `*ManagementClient.NewExtensionMetadataClient() *ExtensionMetadataClient`
- New function `*ManagementClient.NewExtensionMetadataV2Client() *ExtensionMetadataV2Client`
- New function `*ManagementClient.NewExtensionPublisherClient() *ExtensionPublisherClient`
- New function `*ManagementClient.NewExtensionTypeClient() *ExtensionTypeClient`
- New function `*ManagementClient.NewGatewaysClient() *GatewaysClient`
- New function `*ManagementClient.NewHybridIdentityMetadataClient() *HybridIdentityMetadataClient`
- New function `*ManagementClient.NewLicenseProfilesClient() *LicenseProfilesClient`
- New function `*ManagementClient.NewLicensesClient() *LicensesClient`
- New function `*ManagementClient.NewMachineExtensionsClient() *MachineExtensionsClient`
- New function `*ManagementClient.NewMachineRunCommandsClient() *MachineRunCommandsClient`
- New function `*ManagementClient.NewMachinesClient() *MachinesClient`
- New function `*ManagementClient.NewNetworkConfigurationsClient() *NetworkConfigurationsClient`
- New function `*ManagementClient.NewNetworkProfileClient() *NetworkProfileClient`
- New function `*ManagementClient.NewNetworkSecurityPerimeterConfigurationsClient() *NetworkSecurityPerimeterConfigurationsClient`
- New function `*ManagementClient.NewOperationsClient() *OperationsClient`
- New function `*ManagementClient.NewPrivateEndpointConnectionsClient() *PrivateEndpointConnectionsClient`
- New function `*ManagementClient.NewPrivateLinkResourcesClient() *PrivateLinkResourcesClient`
- New function `*ManagementClient.NewPrivateLinkScopesClient() *PrivateLinkScopesClient`
- New function `*ManagementClient.NewSettingsClient() *SettingsClient`
...
## 3.0.0-beta.1 (2026-04-27)
### Breaking Changes

- Function `*ClientFactory.NewManagementClient` has been removed
- Function `NewManagementClient` has been removed
- Function `*ManagementClient.BeginSetupExtensions` has been removed
- Function `*ManagementClient.BeginUpgradeExtensions` has been removed
...
- New function `*Client.NewAgentVersionClient() *AgentVersionClient`
- New function `*Client.NewExtensionMetadataClient() *ExtensionMetadataClient`
- New function `*Client.NewExtensionMetadataV2Client() *ExtensionMetadataV2Client`
- New function `*Client.NewExtensionPublisherClient() *ExtensionPublisherClient`
- New function `*Client.NewExtensionTypeClient() *ExtensionTypeClient`
- New function `*Client.NewGatewaysClient() *GatewaysClient`
- New function `*Client.NewHybridIdentityMetadataClient() *HybridIdentityMetadataClient`
- New function `*Client.NewLicenseProfilesClient() *LicenseProfilesClient`
- New function `*Client.NewLicensesClient() *LicensesClient`
- New function `*Client.NewMachineExtensionsClient() *MachineExtensionsClient`
- New function `*Client.NewMachineRunCommandsClient() *MachineRunCommandsClient`
- New function `*Client.NewMachinesClient() *MachinesClient`
- New function `*Client.NewNetworkConfigurationsClient() *NetworkConfigurationsClient`
- New function `*Client.NewNetworkProfileClient() *NetworkProfileClient`
...
- New function `*Client.NewPrivateLinkScopesClient() *PrivateLinkScopesClient`
- New function `*Client.NewSettingsClient() *SettingsClient`
- New function `*Client.BeginSetupExtensions(ctx context.Context, resourceGroupName string, machineName string, extensions SetupExtensionRequest, options *ClientBeginSetupExtensionsOptions) (*runtime.Poller[ClientSetupExtensionsResponse], error)`
- New function `*ClientFactory.NewAgentVersionClient() *AgentVersionClient`
...
- New function `*HybridIdentityMetadataClient.NewListByMachinesPager(resourceGroupName string, machineName string, options *HybridIdentityMetadataClientListByMachinesOptions) *runtime.Pager[HybridIdentityMetadataClientListByMachinesResponse]`
- New function `*MachineRunCommandsClient.BeginUpdate(ctx context.Context, resourceGroupName string, machineName string, runCommandName string, runCommandProperties MachineRunCommandUpdate, options *MachineRunCommandsClientBeginUpdateOptions) (*runtime.Poller[MachineRunCommandsClientUpdateResponse], error)`
- New function `*MachinesClient.BeginUpgradeExtensions(ctx context.Context, resourceGroupName string, machineName string, extensionUpgradeParameters MachineExtensionUpgrade, options *MachinesClientBeginUpgradeExtensionsOptions) (*runtime.Poller[MachinesClientUpgradeExtensionsResponse], error)`
- New function `NewNetworkConfigurationsClient(subscriptionID string, credential azcore.TokenCredential, options *arm.ClientOptions) (*NetworkConfigurationsClient, error)`
- New function `*NetworkConfigurationsClient.CreateOrUpdate(ctx context.Context, resourceGroupName string, machineName string, parameters NetworkConfiguration, options *NetworkConfigurationsClientCreateOrUpdateOptions) (NetworkConfigurationsClientCreateOrUpdateResponse, error)`
- New function `*NetworkConfigurationsClient.Get(ctx context.Context, resourceGroupName string, machineName string, options *NetworkConfigurationsClientGetOptions) (NetworkConfigurationsClientGetResponse, error)`
- New function `*NetworkConfigurationsClient.Update(ctx context.Context, resourceGroupName string, machineName string, parameters NetworkConfiguration, options *NetworkConfigurationsClientUpdateOptions) (NetworkConfigurationsClientUpdateResponse, error)`
