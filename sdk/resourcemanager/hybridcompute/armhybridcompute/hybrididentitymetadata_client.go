...
// Get - Gets HybridIdentityMetadata.
//
...
//   - metadataName - The id of the HybridIdentityMetadata to get.
...
func (client *HybridIdentityMetadataClient) getCreateRequest(ctx context.Context, resourceGroupName string, machineName string, metadataName string, _ *HybridIdentityMetadataClientGetOptions) (*policy.Request, error) {
...
// NewListByMachinesPager - Implements GET HybridIdentityMetadata in a machine.
//
...
func (client *HybridIdentityMetadataClient) listByMachinesCreateRequest(ctx context.Context, resourceGroupName string, machineName string, _ *HybridIdentityMetadataClientListByMachinesOptions) (*policy.Request, error) {
